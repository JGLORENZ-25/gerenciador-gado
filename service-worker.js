...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* REGRA DE SEGURANÇA PARA MOBILE: Impede que imagens e gráficos estouram a tela */
        ...
        /* CORREÇÃO CSS: Adicionado flex-wrap para evitar quebrar layout em telas pequenas */
        .btn-group-row {
            display: flex;
            gap: 8px;
            flex-wrap: wrap;
        ...
        /* CORREÇÃO CSS: Adicionado flex-wrap e gap para evitar sobreposição */
        .flex-between {
            display: flex;
            justify-content: space-between;
            align-items: center;
        ...
        /* CORREÇÃO CSS: Adicionado flex-wrap e gap no cabeçalho */
        .header-user {
            display: flex;
            align-items: center;
            justify-content: space-between;
        ...
        .paddock-cell.occupied {
            background: var(--primary-light);
            border-color: var(--primary);
            color: var(--primary-dark);
        }

        body.dark-mode .paddock-cell.occupied {
            color: #a7f3d0;
        }
        ...
        body.dark-mode .fin-box-neutral {
        ...
        /* NOVO: Estilos para Gestão de Tarefas */
        ...
        body.dark-mode .task-card.doing {
            background: #451a03;
        }
        ...
        body.dark-mode .task-card-category {
            background: var(--primary-dark);
            color: var(--primary-light);
        }
        ...
        body.dark-mode .task-list-item.doing {
            background: #451a03;
        }
        ...
        .toast-notification.sanitary .toast-icon {
            color: var(--danger);
        }
        ...
        /* NOVO: Botão Flutuante (FAB) para Calculadora */
        .fab-calculator {
            position: fixed;
            bottom: 100px;
            right: 20px;
        ...
        /* NOVO: Template de Recibo (oculto) */
        .receipt-template {
            width: 210mm;
            min-height: 297mm;
            background: white;
        ...
        @media (min-width: 1024px) {
            ...
            /* Kanban visível apenas no Desktop */
            .kanban-board {
                display: grid;
            }
...
<body>
        ...
        <div class="card text-center" style="width: 100%; max-width: 400px; padding: 40px 20px;">
            ...
            <div id="registerFormBlock" class="hidden">
                <form onsubmit="handleRegister(event)">
                    ...
                    <div class="form-group"><input type="email" id="regEmail" class="form-input" placeholder="E-mail para contato" required autocomplete="email"></div>
                    <div class="form-group"><input type="tel" id="regPhone" class="form-input" placeholder="Telefone para contato" autocomplete="tel"></div>
    ...
    <div id="planSelectionScreen" class="hidden" style="padding: 40px 20px; background-color: var(--light); min-height: 100vh;">
        <div style="max-width: 1000px; margin: 0 auto; text-align: center;">
            <h2 style="color: var(--primary); margin-bottom: 10px;">Quase lá! Escolha seu plano</h2>
            <p style="color: var(--gray); margin-bottom: 40px;">Para liberar seu acesso ao sistema, selecione uma das opções abaixo.</p>

            <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">

                <div class="card" style="padding: 30px; width: 300px; max-width: 100%;">
                    <h3 style="color: var(--primary);">Básico</h3>
                    <div style="font-size: 2rem; font-weight: bold; margin: 15px 0;">R$ 49,90<span style="font-size: 1rem; color: var(--gray);">/mês</span></div>
                    <ul style="text-align: left; color: var(--dark); list-style: none; padding: 0; margin-bottom: 25px;">
                        <li>✓ Acesso total ao sistema</li>
                        <li>✓ Uso Offline</li>
                    </ul>
                    <button type="button" onclick="abrirAssinaturaMercadoPago('Basico')" class="btn" style="width: 100%;">
                        Assinar com Mercado Pago
                    </button>
                </div>

                <div class="card" style="padding: 30px; width: 300px; max-width: 100%; border: 2px solid var(--primary); transform: scale(1.05);">
                    <div style="background: var(--primary); color: white; font-size: 0.8rem; padding: 4px 10px; border-radius: 20px; display: inline-block; margin-bottom: 10px;">RECOMENDADO</div>
                    <h3 style="color: var(--primary);">Plano para Gerentes</h3>
                    <p style="margin-bottom: 1rem; font-size: 0.85rem; color: var(--gray); text-align: center;">Para gerente de uma ou mais fazendas</p>
                    <div style="font-size: 2rem; font-weight: bold; margin: 15px 0;" id="gerentePriceApp">R$ 85,90<span style="font-size: 1rem; color: var(--gray);">/mês</span></div>
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: var(--dark); font-size: 0.85rem;">Número de Fazendas:</label>
                        <input type="number" id="numFazendasApp" min="1" value="1" style="width: 100%; padding: 8px; border: 2px solid var(--border); border-radius: 8px; font-size: 0.95rem; background: var(--white); color: var(--dark); transition: border-color 0.3s;" onchange="calcularPrecoGerenteApp()" oninput="calcularPrecoGerenteApp()">
                    </div>
                    <ul style="text-align: left; color: var(--dark); list-style: none; padding: 0; margin-bottom: 25px;">
                        <li>✓ Tudo do Básico</li>
                        <li>✓ Gestão de múltiplas fazendas</li>
                        <li>✓ Acesso centralizado</li>
                        <li>✓ Suporte VIP</li>
                    </ul>
                    <button type="button" onclick="abrirAssinaturaMercadoPago('Assistencia')" class="btn" style="width: 100%;">
                        Assinar com Mercado Pago
                    </button>
                </div>
            </div>
            ...
            <p style="margin-top: 40px; color: var(--gray); font-size: 0.9rem;">
                ...
                <a href="#" onclick="mudarStatusParaAnalise(); return false;" style="color: var(--primary); font-weight: bold;">Clique aqui para validar</a>
            </p>
        </div>
    </div>
    ...
    <div id="appScreen" class="hidden">
        <div class="app-container" style="padding-bottom: 0;">
            <div class="header-user">
                ...
                <div id="contextSelectorContainer" class="hidden" style="flex: 1; margin: 0 15px;">
                ...
                <div class="btn-group-row">
                    ...
                    <button onclick="openModal('modalNotifications')" class="btn btn-outline btn-sm btn-icon-only notification-bell" title="Notificações">
                    ...
                    <button onclick="openSettingsModal()" class="btn btn-outline btn-sm btn-icon-only" title="Configurações">
        ...
        <div class="app-container" id="mainContent">
            <div id="viewDashboard" class="view-section">
                ...
                <div class="card">
                    <h3><i class="fas fa-exclamation-triangle"></i> Análise de Perdas</h3>
            ...
            <div id="viewStock" class="view-section hidden">
                ...
                <div class="fab-calculator" onclick="openModal('modalCalculator')" title="Calculadora de Nutrição">
            ...
            <div id="viewFinancial" class="view-section hidden">
                <div class="flex-between" style="margin-bottom: 16px;">
                    ...
                    <div class="btn-group-row">
                        ...
                        <button class="btn btn-sm btn-secondary" onclick="openReceiptModal()"><i class="fas fa-file-invoice"></i> Recibo</button>
                    </div>
                </div>
                <div class="card">
            ...
            <div id="viewTasks" class="view-section hidden">
                <div class="flex-between" style="margin-bottom: 16px;">
                    <h2><i class="fas fa-tasks"></i> Gestão de Tarefas</h2>
                    <button class="btn btn-sm" onclick="openModal('modalNewTask')">
                ...
                <div class="kanban-board" id="kanbanBoard">
                    ...
                    <div class="kanban-column doing">
                        <div class="kanban-column-header">
                            <i class="fas fa-spinner"></i> Fazendo
                        </div>
                ...
                <div class="tasks-list-mobile" id="tasksListMobile">
                </div>
            </div>
        ...
        <div class="nav-bar">
            ...
            <div class="nav-item" onclick="switchView('viewTasks', this)">
    ...
    <div id="modalSettings" class="modal">
        <div class="modal-content">
            <h3>Configurações</h3>
            <p class="text-gray" style="margin-bottom: 20px;">Personalize a aparência e seus dados de contato.</p>
            <h4 style="margin-bottom:10px;">Dados de contato</h4>
            <div class="form-group"><label class="text-sm text-gray">E-mail</label><input type="email" id="settingsEmail" class="form-input" placeholder="E-mail para contato" autocomplete="email"></div>
            <div class="form-group"><label class="text-sm text-gray">Telefone</label><input type="tel" id="settingsPhone" class="form-input" placeholder="Telefone para contato" autocomplete="tel"></div>
            <button type="button" class="btn btn-sm btn-outline" onclick="saveContactSettings()"><i class="fas fa-save"></i> Salvar contato</button>
            <p id="settingsContactMessage" class="text-sm" style="margin-top:8px; color: var(--success);"></p>
            <label style="display:block; margin-top:25px; margin-bottom:10px; font-weight:600;">Tema do Sistema</label>
            <div class="btn-group-row">
            ...
            <!-- Seção de Gerenciamento de Contas (apenas para gerentes) -->
            <div id="managerAccountsSection" style="display: none; margin-top: 25px;">
                <h4 style="margin-bottom:10px;"><i class="fas fa-users"></i> Gerenciamento de Contas</h4>
                <div class="card" style="padding: 15px; margin-bottom: 15px; background: var(--bg-light);">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                        <div>
                            <p class="text-sm text-gray" style="margin: 0;">Contas criadas</p>
                            <p style="font-size: 1.5rem; font-weight: bold; margin: 5px 0; color: var(--primary);">
                                <span id="managerCreatedAccounts">0</span> / <span id="managerMaxAccounts">0</span>
                            </p>
                        </div>
                    </div>
                    <button type="button" class="btn btn-sm" onclick="openCreateAccountModal()" id="btnCreateAccount" style="width: 100%;">
                        <i class="fas fa-user-plus"></i> Criar Nova Conta Básica
                    </button>
                    <p id="managerAccountsMessage" class="text-sm" style="margin-top:8px; color: var(--success);"></p>
                </div>
            </div>
    ...
    <div id="modalReports" class="modal">
        <div class="modal-content">
            ...
            <p class="text-sm text-gray" style="margin-bottom: 20px;">Selecione o tipo de documento e o período para gerar em PDF.</p>
            ...
            <div class="form-group">
                ...
                <select id="reportType" class="form-input" onchange="toggleReportOptions()">
                    ...
                    <option value="loss_analysis">Análise de Perdas e Mortes</option>
                </select>
            </div>
            ...
            <div class="date-filter-container">
                <label style="font-weight: 600; margin-bottom: 10px; display: block;">
                    <i class="fas fa-calendar-alt"></i> Período do Relatório
                </label>
                
                <div class="date-filter-buttons">
                    <button class="date-filter-btn active" onclick="setDateFilter('week')">
                        <i class="fas fa-calendar-week"></i> Semanal
                    </button>
                    <button class="date-filter-btn" onclick="setDateFilter('month')">
                        <i class="fas fa-calendar"></i> Mensal
                    </button>
                    <button class="date-filter-btn" onclick="setDateFilter('quarter')">
                        <i class="fas fa-calendar-alt"></i> Trimestral
                    </button>
                    <button class="date-filter-btn" onclick="setDateFilter('semester')">
                        <i class="fas fa-calendar-check"></i> Semestral
                    </button>
                    <button class="date-filter-btn" onclick="setDateFilter('year')">
                        <i class="fas fa-calendar-day"></i> Anual
                    </button>
                    <button class="date-filter-btn" onclick="setDateFilter('custom')">
                        <i class="fas fa-calendar-plus"></i> Personalizado
                    </button>
                </div>
                ...
                <div id="customDateInputs" class="custom-date-inputs hidden">
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <input type="date" id="reportStartDate" class="form-input" onchange="updateDateRangeDisplay()">
                    </div>
                    <div class="form-group" style="margin-bottom: 0;">
                        <label class="text-xs">Data Final</label>
                        <input type="date" id="reportEndDate" class="form-input" onchange="updateDateRangeDisplay()">
                    </div>
                </div>

                <div id="dateRangeDisplay" class="date-range-display">
                    <i class="fas fa-info-circle"></i> Últimos 7 dias
                </div>
            </div>
    ...
    <div id="pdf-hidden-container" style="position: fixed; left: -9999px; top: 0;">
        <div id="pdf-template" class="a4-page">
            ...
            <div class="pdf-header">
                ...
                <div style="text-align:right;">
                    ...
                    <div style="font-size:0.7rem; color:#777; margin-top:5px;">Período:</div>
                    <div style="font-weight:bold; font-size:0.8rem;" id="pdf-date-range">--/--/---- a --/--/----</div>
                </div>
            </div>
    ...
    <div id="receipt-hidden-container" style="position: fixed; left: -9999px; top: 0;">
        <div id="receipt-template" class="receipt-template">
            <img src="Branco-removebg-preview.png" class="watermark-img">
            
            <div class="receipt-header">
                <img src="Verde.jpg" alt="Logo MeuGado">
                <div>
                    <h1 style="margin:0; font-size:1.5rem; color:#059669;">MeuGado</h1>
                    <div style="font-size:0.8rem; color:#555;">Sistema de Gestão Pecuária</div>
                </div>
            </div>

            <div class="receipt-title">RECIBO DE COMPRA E VENDA</div>

            <div class="receipt-field">
                <label>Vendedor:</label>
                <p id="receiptSellerName">-</p>
            </div>

            <div class="receipt-field">
                <label>Comprador:</label>
                <p id="receiptBuyerName">-</p>
            </div>

            <div class="receipt-field">
                <label>Descrição do Item/Gado:</label>
                <p id="receiptDescriptionText">-</p>
            </div>

            <div class="receipt-field">
                <label>Valor Total:</label>
                <p id="receiptAmountText" style="font-size: 1.2rem; font-weight: 700; color: #059669;">-</p>
            </div>

            <div class="receipt-field">
                <label>Data:</label>
                <p id="receiptDateText">-</p>
            </div>

            <div class="receipt-field">
                <label>Local:</label>
                <p id="receiptLocationText">-</p>
            </div>

            <div class="signature-section">
                <div class="signature-box">
                    <div class="signature-line"></div>
                    <div class="signature-label">Assinatura do Vendedor</div>
                </div>
                <div class="signature-box">
                    <div class="signature-line"></div>
                    <div class="signature-label">Assinatura do Comprador</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="modalReceipt" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-file-invoice"></i> Gerar Recibo de Compra e Venda</h3>
            <p class="text-sm text-gray" style="margin-bottom: 20px;">Preencha os dados para gerar um recibo profissional em PDF.</p>

            <div class="form-group">
                <label>Vendedor</label>
                <input type="text" id="receiptSeller" class="form-input" placeholder="Nome do vendedor">
                <div class="text-xs text-gray" style="margin-top: 5px;">Preenchido automaticamente com seu nome (editável)</div>
            </div>

            <div class="form-group">
                <label>Comprador</label>
                <input type="text" id="receiptBuyer" class="form-input" placeholder="Nome do comprador">
            </div>

            <div class="form-group">
                <label>Descrição do Item/Gado</label>
                <textarea id="receiptDescription" class="form-input" rows="4" placeholder="Ex: 10 cabeças de gado Nelore, peso médio 450kg..."></textarea>
            </div>

            <div class="form-group">
                <label>Valor Total (R$)</label>
                <input type="number" id="receiptAmount" class="form-input" placeholder="0.00" step="0.01">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="receiptLocation" class="form-input" placeholder="Ex: Cachoeira do Sul - RS">
            </div>

            <button class="btn" onclick="generateReceipt()">
                <i class="fas fa-file-pdf"></i> Gerar Recibo PDF
            </button>
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalReceipt')">Cancelar</button>
        </div>
    </div>

    <div id="modalCalculator" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-calculator"></i> Calculadora de Nutrição</h3>
            <p class="text-sm text-gray" style="margin-bottom: 20px;">Calcule o consumo diário e mensal de ração ou sal mineral.</p>

            <div class="form-group">
                <label>Quantidade de Animais</label>
                <input type="number" id="calcNumAnimals" class="form-input" placeholder="Ex: 100">
            </div>

            <div class="form-group">
                <label>Peso Médio (kg)</label>
                <input type="number" id="calcAvgWeight" class="form-input" placeholder="Ex: 450" step="0.01">
            </div>

            <div class="form-group">
                <label>Tipo de Consumo</label>
                <select id="calcConsumptionType" class="form-input">
                    <option value="percentage">% do Peso Vivo</option>
                    <option value="grams">g/cab/dia</option>
                </select>
            </div>

            <div class="form-group">
                <label>Consumo Diário</label>
                <input type="number" id="calcDailyConsumption" class="form-input" placeholder="Ex: 2 (para 2% do PV) ou 80 (para 80g/cab/dia)" step="0.01">
                <div class="text-xs text-gray" style="margin-top: 5px;">
                    Se % do Peso Vivo: Ex: 2 (para 2%)<br>
                    Se g/cab/dia: Ex: 80 (para 80 gramas por cabeça por dia)
                </div>
            </div>

            <button class="btn btn-secondary" onclick="calculateNutrition()">
            ...
            <div id="calculatorResult" class="calculator-result hidden">
                ...
                <div class="result-item">
                    <span>Consumo Total Diário:</span>
                    <span class="result-value" id="resultDailyConsumption">0 kg</span>
                </div>
                <div class="result-item">
                    <span>Consumo Mensal Estimado:</span>
                    <span class="result-value" id="resultMonthlyConsumption">0 kg</span>
                </div>
                <div class="result-item">
                    <span>Sacas de 30kg (Mensal):</span>
                    <span class="result-value" id="resultBags30kg">0 sacas</span>
                </div>
                <div class="result-item">
                    <span>Sacas de 40kg (Mensal):</span>
                    <span class="result-value" id="resultBags40kg">0 sacas</span>
                </div>
            </div>

            <button class="btn btn-outline" style="margin-top: 20px;" onclick="closeModal('modalCalculator')">Fechar</button>
        </div>
    </div>
    ...
    <div id="modalCreateAccount" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-user-plus"></i> Criar Nova Conta Básica</h3>
            <p class="text-sm text-gray" style="margin-bottom: 20px;">Crie uma nova conta com acesso básico que será automaticamente adicionada às suas fazendas gerenciadas.</p>
            <div class="form-group">
                <label class="text-sm text-gray">Nome de Usuário</label>
                <input type="text" id="newAccountUser" class="form-input" placeholder="Ex: joao_silva" autocomplete="username">
                <small class="text-xs text-gray">Apenas letras, números e underscore</small>
            </div>
            <div class="form-group">
                <label class="text-sm text-gray">Nome Completo</label>
                <input type="text" id="newAccountName" class="form-input" placeholder="Ex: João Silva" autocomplete="name">
            </div>
            <div class="form-group">
                <label class="text-sm text-gray">E-mail (opcional)</label>
                <input type="email" id="newAccountEmail" class="form-input" placeholder="email@exemplo.com" autocomplete="email">
            </div>
            <div class="form-group">
                <label class="text-sm text-gray">Telefone (opcional)</label>
                <input type="tel" id="newAccountPhone" class="form-input" placeholder="(00) 00000-0000" autocomplete="tel">
            </div>
            <div class="form-group">
                <label class="text-sm text-gray">Senha</label>
                <input type="password" id="newAccountPass" class="form-input" placeholder="Mínimo 6 caracteres" autocomplete="new-password">
            </div>
            <p id="createAccountMessage" class="text-sm" style="margin-top:8px; color: var(--danger);"></p>
            <button class="btn" onclick="createBasicAccount()"><i class="fas fa-user-plus"></i> Criar Conta</button>
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalCreateAccount')">Cancelar</button>
        </div>
    </div>
    ...
    <div id="modalNewStockItem" class="modal">
        <div class="modal-content">
            ...
            <div id="stockSemenFields" class="hidden" style="background: var(--light); padding:10px; border-radius:10px; margin-bottom:15px; border:1px dashed var(--primary);">
                <h4 style="color:var(--primary); margin-bottom:10px;"><i class="fas fa-dna"></i> Dados do Reprodutor (Banco de Sêmen com Pedigree)</h4>
                <div class="form-group">
                    <label>Raça</label>
                ...
                <div class="form-group">
                    <label>Foto do Touro (URL)</label>
                    <input type="url" id="stockSemenPhotoUrl" class="form-input" placeholder="https://...">
                </div>
                <div class="form-group">
                    <label>Pedigree / Árvore Genealógica</label>
                    <div class="flex-between gap-2" style="margin-bottom:6px;">
                        <input type="text" id="stockSemenPedigreeSire" class="form-input" placeholder="Pai (Sire)">
                        <input type="text" id="stockSemenPedigreeDam" class="form-input" placeholder="Mãe (Dam)">
                    </div>
                    <textarea id="stockSemenPedigreeTree" class="form-input" rows="2" placeholder="Árvore genealógica (texto livre, opcional)"></textarea>
                </div>
            </div>
            <div class="flex-between gap-2">
                <div class="form-group" style="flex:1">
    ...
    <div id="modalEditStockItem" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-edit"></i> Editar Item de Estoque</h3>
            <input type="hidden" id="stockEditId">
            <div class="form-group">
                <label>Nome do Produto / Touro</label>
                <input type="text" id="stockEditName" class="form-input" placeholder="Ex: Ração, Touro Nelore...">
            </div>
            <div class="form-group">
                <label>Categoria</label>
                <select id="stockEditCategory" class="form-input" onchange="toggleEditSemenFields(this.value)">
                    <option value="Ração">Ração / Nutrição</option>
                    <option value="Sal Mineral">Sal Mineral</option>
                    <option value="Vacina">Vacina</option>
                    <option value="Medicamento">Medicamento</option>
            ...
            <div class="flex-between gap-2">
                <div class="form-group" style="flex:1">
                    ...
                    <input type="number" id="stockEditQty" class="form-input" placeholder="0" step="0.01" min="0">
                </div>
                <div class="form-group" style="flex:1">
                    <label>Unidade</label>
                    <select id="stockEditUnit" class="form-input">
                        <option value="kg">Kg (Quilos)</option>
                        <option value="ds">Doses (Palhetas)</option>
                        <option value="ml">ml (Mililitros)</option>
                        <option value="lt">Lt (Litros)</option>
            ...
            <div class="form-group">
                ...
                <input type="number" id="stockEditAvgPrice" class="form-input" placeholder="0.00" step="0.01" min="0">
            </div>
            <div id="stockEditSemenFields" class="hidden" style="background: var(--light); padding:10px; border-radius:10px; margin-bottom:15px; border:1px dashed var(--primary);">
                <h4 style="color:var(--primary); margin-bottom:8px;"><i class="fas fa-dna"></i> Pedigree / Foto (Sêmen)</h4>
                <div class="form-group">
                    <label>Foto (URL)</label>
                    <input type="url" id="stockEditPhotoUrl" class="form-input" placeholder="https://...">
                </div>
                <div class="flex-between gap-2">
                    <input type="text" id="stockEditPedigreeSire" class="form-input" placeholder="Pai (Sire)">
                    <input type="text" id="stockEditPedigreeDam" class="form-input" placeholder="Mãe (Dam)">
                </div>
                <textarea id="stockEditPedigreeTree" class="form-input" rows="2" placeholder="Árvore genealógica (texto)" style="margin-top:8px;"></textarea>
            </div>
            <div class="btn-group-row">
                <button class="btn" onclick="saveStockItemEdit()"><i class="fas fa-save"></i> Salvar Alterações</button>
                <button type="button" class="btn btn-danger" onclick="openRemoveStockFromEdit()"><i class="fas fa-trash"></i> Excluir</button>
            </div>
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalEditStockItem')">Fechar</button>
        </div>
    </div>

    <div id="modalRemoveStock" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-box-open"></i> Remover do Estoque</h3>
            <input type="hidden" id="stockRemoveId">
            <p class="text-gray" style="margin-bottom: 16px;" id="stockRemoveItemName">—</p>
            <div class="form-group">
                <label>Por que remover do estoque?</label>
                <div style="display:flex; flex-direction:column; gap:10px; margin-top:8px;">
                    <label class="list-item" style="cursor:pointer; display:flex; align-items:center; gap:10px;">
                        <input type="radio" name="stockRemoveReason" value="Uso próprio" onchange="toggleStockRemoveOther()">
                        <span>Uso próprio</span>
                    </label>
                    <label class="list-item" style="cursor:pointer; display:flex; align-items:center; gap:10px;">
                        <input type="radio" name="stockRemoveReason" value="Perda" onchange="toggleStockRemoveOther()">
                        <span>Perda</span>
                    </label>
                    <label class="list-item" style="cursor:pointer; display:flex; align-items:center; gap:10px;">
                        <input type="radio" name="stockRemoveReason" value="Vencimento" onchange="toggleStockRemoveOther()">
                        <span>Vencimento</span>
                    </label>
                    <label class="list-item" style="cursor:pointer; display:flex; align-items:center; gap:10px;">
                        <input type="radio" name="stockRemoveReason" value="Doação" onchange="toggleStockRemoveOther()">
                        <span>Doação</span>
                    </label>
                    <label class="list-item" style="cursor:pointer; display:flex; align-items:center; gap:10px;">
                        <input type="radio" name="stockRemoveReason" value="Descarte" onchange="toggleStockRemoveOther()">
                        <span>Descarte</span>
                    </label>
                    <label class="list-item" style="cursor:pointer; display:flex; align-items:center; gap:10px;">
                        <input type="radio" name="stockRemoveReason" value="Outros" onchange="toggleStockRemoveOther()">
                        <span>Outros</span>
                    </label>
                </div>
            </div>
            <div class="form-group hidden" id="stockRemoveOtherWrap">
                <label>Descreva (opcional)</label>
                <input type="text" id="stockRemoveOtherText" class="form-input" placeholder="Ex: Transferência para outro setor...">
            </div>
            <div class="form-group">
                <label>Quantidade a remover</label>
                <input type="number" id="stockRemoveQty" class="form-input" placeholder="0" step="0.01" min="0">
                <div class="text-sm text-gray" style="margin-top:4px;">Disponível: <span id="stockRemoveAvailable">0</span></div>
                <label style="display:flex; align-items:center; gap:8px; margin-top:8px;">
                    <input type="checkbox" id="stockRemoveAll" onchange="toggleStockRemoveAll()">
                    Remover todo o estoque deste item
                </label>
            </div>
            <button type="button" class="btn btn-danger" onclick="confirmRemoveStock()"><i class="fas fa-trash"></i> Confirmar remoção</button>
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalRemoveStock')">Fechar</button>
        </div>
    </div>
    ...
    <div id="modalGroupDetails" class="modal">
        <div class="modal-content">
            ...
            <div class="tabs">
                ...
                <div class="tab" onclick="switchTab('tabBreeding', event)" style="color:var(--pink);">Reprodução</div>
            ...
            <div id="tabBreeding" class="tab-content hidden">
                <div class="card bg-card-repro">
                    ...
                    <div class="form-group">
                        ...
                        <select id="breedingBullSelect" class="form-input" onchange="showBullPedigree(this.value)"></select>
                        <div id="breedingBullAlert" class="text-xs text-danger hidden" style="margin-top:2px;">Estoque baixo!</div>
                        <div id="breedingBullPedigreeBox" class="hidden" style="margin-top:10px; padding:10px; background:var(--light); border-radius:10px; border:1px solid var(--border);">
                            <div id="breedingBullPhoto" class="text-center" style="margin-bottom:8px;"></div>
                            <div id="breedingBullPedigree" class="text-sm text-gray"></div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex-between gap-2" style="margin-bottom:5px;">
                            <label style="flex:1; display:flex; align-items:center; gap:5px; font-weight:normal;">
                                <input type="radio" name="breedingScope" value="all" checked onchange="toggleBreedingScope()">
                                Lote Inteiro
                            </label>
                            <label style="flex:1; display:flex; align-items:center; gap:5px; font-weight:normal;">
                                <input type="radio" name="breedingScope" value="individual" onchange="toggleBreedingScope()">
                                Individual
                            </label>
                        </div>
                ...
                <div class="card" style="margin-top:20px; border-color:var(--primary);">
                    <h4 style="color:var(--primary);"><i class="fas fa-dna"></i> Banco de Sêmen com Pedigree</h4>
                    <p class="text-sm text-gray" style="margin-bottom:10px;">Touros cadastrados com foto e árvore genealógica.</p>
                    <div id="semenBankList"></div>
                </div>
                <div class="card" style="margin-top:20px; border-color:var(--pink);">
                    <h4 style="color:var(--pink);"><i class="fas fa-crown"></i> Matrizes de Elite</h4>
                    <p class="text-sm text-gray" style="margin-bottom:10px;">Ranking das vacas por GMD médio dos bezerros (ajuda a decidir quais matrizes manter).</p>
                    <div id="eliteMatricesList"></div>
                </div>
            ...
            <div id="tabStockUse" class="tab-content hidden">
                <div class="card bg-card-use">
                    ...
                    <div class="flex-between gap-2" style="margin-bottom: 15px;">
                        <label style="flex:1; display:flex; align-items:center; gap:5px; font-weight:normal;">
                            <input type="radio" name="usageScope" value="lot" id="scopeLot" checked onchange="toggleIndividualUsage()">
                            Uso no Lote
                        </label>
                        <label style="flex:1; display:flex; align-items:center; gap:5px; font-weight:normal;">
                            <input type="radio" name="usageScope" value="individual" id="scopeIndividual" onchange="toggleIndividualUsage()">
                            Uso Individual
                        </label>
                    </div>
            ...
            <div id="tabWeights" class="tab-content hidden">
                ...
                <div class="card" style="margin-top:10px;">
                    <label class="text-sm text-gray">Pesagem individual (para GMD do animal / Matrizes de Elite)</label>
                    <div class="flex-between gap-2" style="flex-wrap:wrap;">
                        <input type="date" id="weightIndivDate" class="form-input">
                        <select id="weightIndivAnimal" class="form-input" style="min-width:120px;"></select>
                        <input type="number" id="weightIndivValue" class="form-input" placeholder="Kg" step="0.01">
                        <button class="btn btn-sm" onclick="addIndividualWeight()">Registrar</button>
                    </div>
                </div>
            ...
            <div id="tabAnimals" class="tab-content hidden">
                ...
                <div id="animalList" style="max-height: 250px; overflow-y: auto; margin-top:10px;"></div>
            </div>
    ...
    <div id="modalRemoveAnimal" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-exclamation-triangle"></i> Baixa de Animal</h3>
            <p class="text-sm text-gray" style="margin-bottom: 20px;">Informe o motivo da saída do animal <strong id="removeAnimalName"></strong> do lote.</p>
            <div class="form-group">
                <label>Motivo da Baixa</label>
                <select id="removeReason" class="form-input" onchange="toggleDeathCause()">
                    <option value="">Selecione...</option>
                    <option value="Venda">Venda</option>
                    <option value="Morte">Morte</option>
                    <option value="Roubo">Roubo</option>
                    <option value="Consumo Próprio">Consumo Próprio</option>
                    <option value="Transferência">Transferência para outro lote</option>
                </select>
            </div>
            <div id="deathCauseBlock" class="form-group hidden">
                <label>Causa da Morte</label>
                <select id="deathCause" class="form-input">
                    <option value="">Selecione...</option>
                    <option value="Picada de Cobra">Picada de Cobra</option>
                    <option value="Doença Respiratória">Doença Respiratória</option>
                    <option value="Doença Digestiva">Doença Digestiva</option>
                    <option value="Acidente">Acidente</option>
                    <option value="Parto">Complicação no Parto</option>
                    <option value="Predador">Ataque de Predador</option>
                    <option value="Intoxicação">Intoxicação Alimentar</option>
                    <option value="Desconhecida">Causa Desconhecida</option>
                    <option value="Outra">Outra</option>
                </select>
            </div>
            <div class="form-group">
                <label>Data da Ocorrência</label>
                <input type="date" id="removeDate" class="form-input">
            </div>
            <div class="form-group">
                <label>Observações (Opcional)</label>
                <textarea id="removeNotes" class="form-input" rows="3" placeholder="Detalhes adicionais..."></textarea>
            </div>
            <input type="hidden" id="removeAnimalIndex">
            <button class="btn btn-danger" onclick="confirmRemoveAnimal()">Confirmar Baixa</button>
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalRemoveAnimal')">Cancelar</button>
        </div>
    </div>

    <div id="modalAnimalDetails" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-tag"></i> Detalhes do Animal</h3>
            <div style="background: var(--light); padding: 15px; border-radius: 12px; margin-bottom: 20px;">
                <div class="flex-between" style="margin-bottom: 10px;">
                    <span class="text-gray">Identificação:</span>
                    <strong id="animalDetailId">-</strong>
                </div>
                <div class="flex-between" style="margin-bottom: 10px;">
                    <span class="text-gray">Peso Atual:</span>
                    <strong id="animalDetailWeight">-</strong>
                </div>
                <div class="flex-between" style="margin-bottom: 10px;">
                    <span class="text-gray">Entrada no Lote:</span>
                    <strong id="animalDetailEntry">-</strong>
                </div>
            </div>
            <div class="growth-chart-container">
                <h4 style="margin-bottom: 15px;"><i class="fas fa-chart-line"></i> Curva de Crescimento</h4>
                <canvas id="animalGrowthChart" height="200"></canvas>
                <div class="text-xs text-gray text-center" style="margin-top: 10px;">
                    Linha azul: Peso do animal | Linha verde: Média do lote
                </div>
            </div>
            <button class="btn btn-outline" style="margin-top: 20px;" onclick="closeModal('modalAnimalDetails')">Fechar</button>
        </div>
    </div>
    ...
    <div id="modalTransaction" class="modal">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <textarea id="transNotes" class="form-input" rows="3" placeholder="Anotações sobre esta receita ou despesa..."></textarea>
            </div>
            <input type="hidden" id="transType">
            <input type="hidden" id="transId">
            <div class="btn-group-row">
                <button class="btn" id="btnSaveTrans" onclick="saveTransaction()"><i class="fas fa-save"></i> Salvar</button>
                <button type="button" class="btn btn-danger" id="btnTransExcluir" onclick="removeTransaction()" style="display: none;"><i class="fas fa-trash"></i> Excluir</button>
            </div>
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalTransaction')">Fechar</button>
        </div>
    </div>
    ...
    <div id="modalNewTask" class="modal">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input type="text" id="taskTitle" class="form-input" placeholder="Ex: Vacinar lote 01">
            </div>
            <div class="form-group">
                <label>Categoria</label>
            ...
            <div class="form-group">
                ...
                <input type="number" id="taskReminderDays" class="form-input" placeholder="Ex: 1" value="1" min="0">
                <div class="text-sm text-gray" style="margin-top: 5px;">Você será notificado X dias antes do prazo.</div>
            </div>
            <div class="form-group">
                <label>Descrição / Observações</label>
                <textarea id="taskDescription" class="form-input" rows="4" placeholder="Detalhes sobre a tarefa..."></textarea>
            </div>
            <button class="btn" onclick="createTask()">
                <i class="fas fa-save"></i> Criar Tarefa
            </button>
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalNewTask')">Cancelar</button>
        </div>
    </div>

    <div id="modalTaskDetails" class="modal">
        <div class="modal-content">
            <h3><i class="fas fa-clipboard-check"></i> Detalhes da Tarefa</h3>
            <input type="hidden" id="currentTaskId">
            
            <div style="background: var(--light); padding: 15px; border-radius: 12px; margin-bottom: 20px;">
                <div class="flex-between" style="margin-bottom: 10px;">
                    <strong id="taskDetailTitle" style="font-size: 1.1rem; color: var(--dark);">Título</strong>
                    <span id="taskDetailStatus" class="badge badge-gray">Status</span>
                </div>
                <div class="text-sm text-gray" style="margin-bottom: 10px;">
                    <i class="fas fa-tag"></i> <span id="taskDetailCategory">Categoria</span>
                </div>
                <div class="text-sm text-gray">
                    <i class="fas fa-calendar-alt"></i> Prazo: <span id="taskDetailDeadline">--/--/----</span>
                </div>
            </div>

            <div class="form-group">
                <label>Descrição / O que foi feito</label>
                <textarea id="taskDetailDescription" class="form-input" rows="5"></textarea>
            </div>

            <div class="form-group">
                <label>Alterar Status</label>
                <select id="taskDetailStatusSelect" class="form-input" onchange="updateTaskStatus()">
            ...
            <div class="btn-group-row">
                <button class="btn" onclick="saveTaskDetails()">
            ...
            <button class="btn btn-outline" style="margin-top: 10px;" onclick="closeModal('modalTaskDetails')">Fechar</button>
        </div>
    </div>
    ...
    <div id="modalNotifications" class="modal">
        <div class="modal-content">
            ...
            <div id="notificationsList" class="notification-list">
                <p class="text-center text-gray" style="padding: 40px;">Nenhuma notificação</p>
            </div>
            <button class="btn btn-outline" style="margin-top: 20px;" onclick="closeModal('modalNotifications')">Fechar</button>
        </div>
    </div>
    ...
    <script>
        ...
        const legalTexts = {
            terms: `
                ...
                <p>Os valores dos planos são estabelecidos conforme a modalidade contratada. O não pagamento pode resultar em suspensão do acesso. Alterações de plano podem ser feitas a qualquer momento, com efeito imediato ou no próximo ciclo de cobrança, conforme o plano escolhido.</p>
                <h4>7. Proibição de Revenda</h4>
                <p><strong>É expressamente proibida a revenda do sistema, de licenças ou de acessos a terceiros.</strong> Em caso de detecção de revenda não autorizada, as contas envolvidas serão imediatamente encerradas e será cobrado o valor real de uso do sistema, calculado com base no número de usuários, fazendas e período de utilização irregular, além de multa contratual equivalente a 10 vezes o valor mensal do plano contratado. A empresa gestora será responsabilizada por todos os custos decorrentes da violação.</p>
                <h4>8. Uso Indevido</h4>
                <p>É proibido utilizar para fins ilegais, copiar, modificar, criar produtos derivados, realizar engenharia reversa, compartilhar credenciais não autorizadas ou utilizar o sistema de forma que viole direitos de propriedade intelectual.</p>
                <h4>9. Transferência de Conta</h4>
                <p>A transferência de contas ou licenças entre empresas ou pessoas físicas é proibida sem autorização prévia e por escrito. Cada conta é vinculada à empresa gestora que realizou a contratação.</p>
                <h4>10. Suspensão e Encerramento</h4>
                <p>Contas que violem os termos podem ser suspensas ou encerradas sem aviso prévio. Em caso de encerramento por violação, não haverá reembolso de valores pagos.</p>
                <h4>11. Modificações dos Termos</h4>
                <p>Os termos podem ser atualizados periodicamente. O uso continuado do sistema após as alterações implica em aceitação dos novos termos.</p>
            `,
            privacy: `
                <h4>1. Dados Coletados</h4>
                <ul>
                    <li><strong>Identificação:</strong> nome completo, e-mail, CPF/CNPJ, telefone, endereço, login e senha (criptografada).</li>
                    <li><strong>Profissionais:</strong> empresa, propriedades rurais, número de fazendas, área total, atividade principal.</li>
                    <li><strong>Produtivos:</strong> animais, registros zootécnicos, manejo sanitário, vacinas, GTAs, custos de produção, vendas.</li>
                    <li><strong>Técnicos:</strong> cookies, cache offline, logs de acesso, endereço IP, tipo de dispositivo, navegador utilizado.</li>
                    <li><strong>Financeiros:</strong> informações de pagamento processadas pelo Mercado Pago (não armazenamos dados completos de cartão).</li>
                </ul>
                <h4>2. Finalidade do Tratamento</h4>
                <p>Os dados são coletados para: operação do sistema, geração de relatórios, melhoria da plataforma, cumprimento de obrigações legais, prevenção de fraudes, comunicação com o usuário e análise estatística. Não utilizamos dados para publicidade de terceiros.</p>
                <h4>3. Base Legal</h4>
                <p>O tratamento é baseado em: execução de contrato, cumprimento de obrigação legal, legítimo interesse e consentimento do titular.</p>
                <h4>4. Armazenamento</h4>
                <p>Dados são armazenados em servidores na nuvem (Firebase/Google Cloud) e em bancos de dados locais no dispositivo (para uso offline). Adotamos medidas de segurança técnicas e administrativas, incluindo criptografia, controle de acesso e backups regulares. Os dados são mantidos enquanto necessário para as finalidades descritas ou por período legalmente exigido.</p>
                <h4>5. Compartilhamento</h4>
                <p>Dados não são vendidos ou alugados. Podem ser compartilhados apenas: (a) entre usuários autorizados da mesma empresa gestora; (b) com prestadores de serviços essenciais (hospedagem, processamento de pagamento) sob acordos de confidencialidade; (c) quando exigido por lei ou ordem judicial; (d) com autoridades competentes em caso de investigação.</p>
                <h4>6. Segurança</h4>
                <p>Implementamos medidas de segurança como SSL/TLS, autenticação de dois fatores (quando disponível), monitoramento de acessos suspeitos e atualizações regulares de segurança. O usuário é responsável por manter suas credenciais seguras e não compartilhá-las.</p>
                <h4>7. Direitos do Titular (LGPD)</h4>
                <p>Você tem direito a: acesso aos dados, correção de dados incompletos ou desatualizados, exclusão de dados desnecessários, portabilidade dos dados, revogação do consentimento, informação sobre compartilhamento, revisão de decisões automatizadas. Solicitações devem ser feitas via e-mail: meugadoonline@gmail.com, com resposta em até 15 dias úteis.</p>
                <h4>8. Cookies e Tecnologias Similares</h4>
                <p>Utilizamos cookies essenciais para funcionamento do sistema e armazenamento offline. Não utilizamos cookies de rastreamento ou publicidade de terceiros.</p>
                <h4>9. Dados de Menores</h4>
                <p>O sistema não é destinado a menores de 18 anos. Não coletamos intencionalmente dados de menores sem consentimento dos responsáveis.</p>
                <h4>10. Alterações na Política</h4>
                <p>Esta política pode ser atualizada. Alterações significativas serão comunicadas por e-mail ou notificação no sistema.</p>
            `,
            eula: `
                <h4>1. Licença</h4>
                <p>O MeuGado é licenciado, não vendido. Concessão de licença limitada, não exclusiva, intransferível, não sublicenciável e revogável para uso pessoal ou empresarial conforme o plano contratado. A licença é válida apenas enquanto o plano estiver ativo e os termos forem respeitados.</p>
                <h4>2. Propriedade Intelectual</h4>
                <p>Todo o sistema, código-fonte, algoritmos, interface, marca, logotipo, documentação e demais elementos pertencem exclusivamente a <strong>63.992.533 JOAO GUILHERME POZZEBON LORENZ</strong>. Esta licença não transfere qualquer direito de propriedade ao licenciado.</p>
                <h4>3. Restrições de Uso</h4>
                <p>É expressamente proibido: (a) copiar, reproduzir ou duplicar o software; (b) modificar, adaptar, traduzir ou criar obras derivadas; (c) fazer engenharia reversa, descompilar ou desmontar; (d) remover ou alterar avisos de propriedade; (e) <strong>revender, sublicenciar, alugar ou transferir a licença ou acesso a terceiros</strong>; (f) utilizar o software para desenvolver produto concorrente; (g) compartilhar credenciais não autorizadas.</p>
                <h4>4. Revenda e Transferência Proibidas</h4>
                <p><strong>A revenda do sistema, de licenças ou de acessos é estritamente proibida.</strong> Em caso de violação: (a) todas as contas envolvidas serão imediatamente encerradas; (b) será cobrado o valor real de uso calculado com base em número de usuários, fazendas e período de utilização irregular; (c) será aplicada multa contratual equivalente a 10 vezes o valor mensal do plano contratado; (d) o licenciado será responsabilizado por todos os custos e danos decorrentes.</p>
                <h4>5. Uso Permitido</h4>
                <p>O licenciado pode utilizar o software apenas para gestão de suas próprias propriedades rurais ou da empresa gestora contratante, conforme o plano adquirido. O uso deve estar em conformidade com todos os termos e condições.</p>
                <h4>6. Atualizações e Suporte</h4>
                <p>Atualizações podem ser fornecidas durante a vigência da licença. O suporte técnico está sujeito aos termos do plano contratado. Não há garantia de que atualizações serão compatíveis com versões anteriores.</p>
                <h4>7. Garantias e Limitações</h4>
                <p>O software é fornecido "como está", sem garantias expressas ou implícitas. O licenciador não se responsabiliza por perdas de dados, lucros cessantes ou danos indiretos decorrentes do uso ou impossibilidade de uso.</p>
                <h4>8. Encerramento</h4>
                <p>A licença encerra automaticamente em caso de: (a) violação dos termos; (b) cancelamento do plano; (c) não pagamento; (d) solicitação do licenciador. Após o encerramento, o acesso será bloqueado e os dados poderão ser excluídos após período de retenção legal.</p>
                <h4>9. Indenização</h4>
                <p>O licenciado concorda em indenizar o licenciador por todos os custos, danos e prejuízos decorrentes de violação desta licença, incluindo honorários advocatícios.</p>
                <h4>10. Lei Aplicável</h4>
                <p>Esta licença é regida pelas leis brasileiras. Disputas serão resolvidas no foro da comarca de Cachoeira do Sul - RS.</p>
            `
        };
        ...
        function getIconForType(type) {
            ...
            if(type === 'Aves') return 'fas fa-feather';
            if(type === 'Suínos') return 'fas fa-piggy-bank';
        ...
        window.onload = async function() {
            ...
            if (savedUser) {
                ...
                try {
                    const authDoc = await db.collection('auth').doc(currentUser.id).get();
                    const status = (authDoc.exists && authDoc.data().status_assinatura) ? authDoc.data().status_assinatura : 'ativo';
                    await rotearUsuario(status);
                } catch (err) {
                    console.error('Erro ao verificar status:', err);
                    await rotearUsuario('ativo');
                }
            }
        ...
        async function loadData(targetUserId) {
            ...
            try {
                ...
                if (doc.exists) {
                    ...
                    appData.animalLosses = data.animalLosses || [];
        ...
        /** Esconde todas as telas e mostra apenas a indicada. Usado para fluxo login → planos → app (verificação redireciona para verificacao.html) */
        function mostrarTela(id) {
            const telas = ['authScreen', 'planSelectionScreen', 'appScreen'];
            telas.forEach(tela => {
                ...
                if (tela === id) {
                    ...
                    // Se for a tela de planos, inicializar o cálculo do preço
                    if (tela === 'planSelectionScreen') {
                        setTimeout(() => calcularPrecoGerenteApp(), 100);
                    }
                } else {
        ...
        /** Roteia o usuário conforme status_assinatura no Firestore: pendente → planos, em_analise → verificação, ativo → dashboard */
        async function rotearUsuario(status) {
            mostrarTela('authScreen'); // esconde tudo primeiro
            document.getElementById('authScreen').classList.add('hidden');
            document.getElementById('planSelectionScreen').classList.add('hidden');
            ...
            if (status === 'ativo') {
                ...
                // pendente ou qualquer outro: tela de planos
                const el = document.getElementById('planSelectionScreen');
                el.classList.remove('hidden');
                el.style.display = 'block';
                // Inicializar o cálculo do preço do plano para gerentes
                setTimeout(() => calcularPrecoGerenteApp(), 100);
            }
        }

        /** Links de assinatura Mercado Pago (planos) */
        const LINKS_ASSINATURA_MP = {
            Basico: 'https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=91de7abb5ce8446b910c63ad5641167b',
            Assistencia: 'https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=2869de8f0ab94f7db3ce64191c4b5f05'
        };

        /** Abre o checkout de assinatura do Mercado Pago no plano escolhido */
        function abrirAssinaturaMercadoPago(plano) {
            const url = LINKS_ASSINATURA_MP[plano];
            if (url) {
                window.open(url, '_blank');
            } else {
                console.warn('Plano não encontrado:', plano);
            }
        }

        /** Atualiza status no Firestore para em_analise e redireciona para a página de verificação */
        function mudarStatusParaAnalise() {
            if (!currentUser || !currentUser.id) return;
            db.collection('auth').doc(currentUser.id).update({
                status_assinatura: 'em_analise',
        ...
        /** Logout a partir das telas de planos/verificação (mesmo efeito que Sair no app) */
        ...
        async function handleLogin(e) {
            ...
            try {
                ...
                const status = authData.status_assinatura || 'ativo';
                await rotearUsuario(status);
            } catch (error) {
        ...
        function getCurrentLotWeight(group) {
            if (group.animals && group.animals.length > 0) {
                ...
                if (animalsWithWeight.length > 0) {
                    ...
                    return {
                        weight: (totalWeight / animalsWithWeight.length),
                        source: 'INDIVIDUAL'
                    };
                }
            }
            if (group.weighings && group.weighings.length > 0) {
                return {
                    weight: group.weighings[group.weighings.length - 1].weight,
                    source: 'LOTE'
                };
            }
        ...
        function setDateFilter(type) {
            ...
            reportDateFilter.startDate = startDate.toISOString().split('T')[0];
            reportDateFilter.endDate = endDate.toISOString().split('T')[0];
        ...
        function updateDateRangeDisplay() {
            ...
            if (reportDateFilter.type === 'custom') {
                const start = document.getElementById('reportStartDate').value;
                const end = document.getElementById('reportEndDate').value;
                
                if (start && end) {
                    reportDateFilter.startDate = start;
                    reportDateFilter.endDate = end;
                    
                    const startFormatted = new Date(start).toLocaleDateString('pt-BR');
                    const endFormatted = new Date(end).toLocaleDateString('pt-BR');
                    display.innerHTML = `<i class="fas fa-calendar-check"></i> ${startFormatted} até ${endFormatted}`;
                } else {
                    display.innerHTML = `<i class="fas fa-info-circle"></i> Selecione as datas`;
                }
            } else {
                const labels = {
                    'week': 'Últimos 7 dias',
                ...
                const startFormatted = new Date(reportDateFilter.startDate).toLocaleDateString('pt-BR');
                const endFormatted = new Date(reportDateFilter.endDate).toLocaleDateString('pt-BR');
                
                display.innerHTML = `<i class="fas fa-info-circle"></i> ${labels[reportDateFilter.type]}<br>
                    <span style="font-size: 0.85rem;">${startFormatted} até ${endFormatted}</span>`;
            }
        }
        ...
        function isDateInRange(dateStr) {
            ...
            const start = new Date(reportDateFilter.startDate);
            const end = new Date(reportDateFilter.endDate);
            return date >= start && date <= end;
        }

        // --- NOVO: FUNÇÕES DE GESTÃO DE TAREFAS ---
        
        async function createTask() {
            const title = document.getElementById('taskTitle').value.trim();
            const category = document.getElementById('taskCategory').value;
            const deadline = document.getElementById('taskDeadline').value;
            const reminderDays = parseInt(document.getElementById('taskReminderDays').value) || 1;
            ...
            document.getElementById('taskReminderDays').value = '1';
            document.getElementById('taskDescription').value = '';
            document.getElementById('taskCategory').value = 'Manejo';
        ...
        function renderTasks() {
            renderKanbanBoard();
            renderTasksListMobile();
        }

        function renderKanbanBoard() {
            const todoContainer = document.getElementById('kanbanTodo');
            const doingContainer = document.getElementById('kanbanDoing');
            const doneContainer = document.getElementById('kanbanDone');

            const todoTasks = appData.tasks.filter(t => t.status === 'todo');
            const doingTasks = appData.tasks.filter(t => t.status === 'doing');
            const doneTasks = appData.tasks.filter(t => t.status === 'done');

            todoContainer.innerHTML = todoTasks.length === 0 
                ? '<p class="text-sm text-gray text-center" style="padding: 20px;">Nenhuma tarefa</p>'
                : todoTasks.map(task => createTaskCard(task)).join('');

            doingContainer.innerHTML = doingTasks.length === 0 
                ? '<p class="text-sm text-gray text-center" style="padding: 20px;">Nenhuma tarefa</p>'
                : doingTasks.map(task => createTaskCard(task)).join('');
        ...
        function createTaskCard(task) {
            ...
            if (task.status !== 'done') {
                if (daysUntilDeadline < 0) {
                    ...
                    deadlineText = `Atrasada (${Math.abs(daysUntilDeadline)} dias)`;
                } else if (daysUntilDeadline === 0) {
                    deadlineClass = 'text-danger';
                    deadlineText = 'Vence hoje!';
                } else if (daysUntilDeadline <= task.reminderDays) {
                    deadlineClass = 'text-warning';
                    deadlineText = `${daysUntilDeadline} dias restantes`;
                } else {
                    deadlineClass = 'text-gray';
                    deadlineText = `${daysUntilDeadline} dias restantes`;
                }
            } else {
                deadlineText = 'Concluída';
                deadlineClass = 'text-success';
            }

            return `
                <div class="task-card ${task.status}" onclick="openTaskDetails(${task.id})">
                    <div class="task-card-title">${task.title}</div>
                    <span class="task-card-category">${task.category}</span>
                    <div class="text-xs ${deadlineClass}" style="margin-top: 5px;">
                        <i class="fas fa-calendar-alt"></i> ${deadlineText}
                    </div>
                    <div class="task-card-actions">
                        ${task.status === 'todo' ? `<button class="btn btn-sm btn-outline" onclick="event.stopPropagation(); moveTaskStatus(${task.id}, 'doing')" style="font-size: 0.75rem; padding: 4px 8px;">Iniciar</button>` : ''}
                        ${task.status === 'doing' ? `<button class="btn btn-sm btn-success" onclick="event.stopPropagation(); moveTaskStatus(${task.id}, 'done')" style="font-size: 0.75rem; padding: 4px 8px;">Concluir</button>` : ''}
                        ${task.status === 'done' ? `<button class="btn btn-sm btn-outline" onclick="event.stopPropagation(); moveTaskStatus(${task.id}, 'todo')" style="font-size: 0.75rem; padding: 4px 8px;">Reabrir</button>` : ''}
                    </div>
                </div>
            `;
        }

        function renderTasksListMobile() {
            const container = document.getElementById('tasksListMobile');
            
            const doingTasks = appData.tasks.filter(t => t.status === 'doing');
            const todoTasks = appData.tasks.filter(t => t.status === 'todo');
            const doneTasks = appData.tasks.filter(t => t.status === 'done');
            
            const orderedTasks = [...doingTasks, ...todoTasks, ...doneTasks];

            if (orderedTasks.length === 0) {
                container.innerHTML = '<p class="text-center text-gray" style="padding: 40px;">Nenhuma tarefa cadastrada</p>';
                return;
            }
            ...
            container.innerHTML = orderedTasks.map(task => {
                ...
                return `
                    <div class="task-list-item ${task.status}" onclick="openTaskDetails(${task.id})">
                        <div class="flex-between" style="margin-bottom: 8px;">
                            <strong style="color: var(--dark);">${task.title}</strong>
                            <span class="badge ${statusBadgeClass[task.status]}">${statusLabels[task.status]}</span>
                        </div>
                        <div class="text-sm text-gray">
        ...
        function openTaskDetails(taskId) {
            ...
            document.getElementById('taskDetailCategory').innerText = task.category;
            document.getElementById('taskDetailDeadline').innerText = new Date(task.deadline).toLocaleDateString('pt-BR');
            ...
            statusBadge.innerText = statusLabels[task.status];
        ...
        async function saveTaskDetails() {
            ...
            if (task) {
                ...
                task.status = document.getElementById('taskDetailStatusSelect').value;
        ...
        function updateTaskStatus() {
            const newStatus = document.getElementById('taskDetailStatusSelect').value;
            const statusLabels = {
                'todo': 'A Fazer',
                'doing': 'Fazendo',
                'done': 'Feito'
            ...
            const statusBadge = document.getElementById('taskDetailStatus');
            statusBadge.innerText = statusLabels[newStatus];
            statusBadge.className = `badge ${statusBadgeClass[newStatus]}`;
        }
        ...
        function checkTaskNotifications() {
            ...
            appData.tasks.forEach(task => {
                ...
                if (daysUntilDeadline <= task.reminderDays && daysUntilDeadline >= 0) {
                    ...
                    if (!existingNotification) {
                        const message = daysUntilDeadline === 0 
                            ...
                            : `A tarefa "${task.title}" vence em ${daysUntilDeadline} dia(s).`;

                        createNotification('task', 'Lembrete de Tarefa', message, task.id);
                    }
                }
                ...
                if (daysUntilDeadline < 0) {
                    ...
                    if (!existingNotification) {
                        const message = `A tarefa "${task.title}" está atrasada há ${Math.abs(daysUntilDeadline)} dia(s)!`;
                        createNotification('task', 'Tarefa Atrasada', message, task.id);
                    }
                }
            });
        }

        function checkSanitaryNotifications() {
            const today = new Date();
            today.setHours(0, 0, 0, 0);
            ...
            appData.groups.forEach(group => {
                if (group.sold || !group.health) return;

                group.health.forEach(healthRecord => {
                    const withdrawEndDate = new Date(healthRecord.withdrawEnd);
                    withdrawEndDate.setHours(0, 0, 0, 0);

                    if (withdrawEndDate.getTime() === today.getTime() || withdrawEndDate.getTime() === tomorrow.getTime()) {
                        const existingNotification = appData.notifications.find(n => 
                            n.type === 'sanitary' && 
                            n.relatedId === group.id && 
                            new Date(n.date).toDateString() === today.toDateString() &&
                            n.message.includes(healthRecord.name)
                        );

                        if (!existingNotification) {
                            const daysText = withdrawEndDate.getTime() === today.getTime() ? 'hoje' : 'amanhã';
                            const message = `Carência de "${healthRecord.name}" no lote "${group.name}" termina ${daysText}.`;
                            createNotification('sanitary', 'Fim de Carência Sanitária', message, group.id);
                        }
                    }
                });
            });
        ...
        function showToastNotification(type, title, message) {
            ...
            toast.className = `toast-notification ${type === 'sanitary' ? 'sanitary' : ''}`;
            
            toast.innerHTML = `
                <div class="toast-header">
                    <i class="fas ${type === 'sanitary' ? 'fa-syringe' : 'fa-bell'} toast-icon"></i>
        ...
        function renderNotifications() {
            ...
            if (appData.notifications.length === 0) {
                container.innerHTML = '<p class="text-center text-gray" style="padding: 40px;">Nenhuma notificação</p>';
                return;
            }
                ...
                return `
                    <div class="notification-item ${notification.read ? '' : 'unread'} ${notification.type}" 
                        ...
                        <div class="notification-title">
                            <i class="fas ${notification.type === 'sanitary' ? 'fa-syringe' : 'fa-tasks'}"></i>
                            ${notification.title}
                        </div>
                        <div class="notification-message">${notification.message}</div>
                        <div class="notification-date">${dateStr} às ${timeStr}</div>
                    </div>
                `;
            }).join('');
        ...
        // --- NOVO: FUNÇÕES DE RECIBO PDF ---
        
        function openReceiptModal() {
            if (currentUser) {
                document.getElementById('receiptSeller').value = currentUser.fullName;
            }
        ...
        async function generateReceipt() {
            const seller = document.getElementById('receiptSeller').value.trim();
            const buyer = document.getElementById('receiptBuyer').value.trim();
            ...
            if (!seller || !buyer || !description || !amount || !date || !location) {
                alert('Por favor, preencha todos os campos do recibo.');
                return;
            }

            document.getElementById('receiptSellerName').innerText = seller;
            document.getElementById('receiptBuyerName').innerText = buyer;
            document.getElementById('receiptDescriptionText').innerText = description;
            document.getElementById('receiptAmountText').innerText = `R$ ${amount.toFixed(2)}`;
            document.getElementById('receiptDateText').innerText = new Date(date).toLocaleDateString('pt-BR');
            document.getElementById('receiptLocationText').innerText = location;

            const element = document.getElementById('receipt-template');
            const opt = {
                margin: 0,
                filename: `Recibo_${buyer.replace(/\s+/g, '_')}_${date}.pdf`,
            ...
            setTimeout(() => {
                html2pdf().set(opt).from(element).save().then(() => {
                    ...
                    document.getElementById('receiptBuyer').value = '';
        ...
        // --- NOVO: FUNÇÕES DE CALCULADORA DE NUTRIÇÃO ---
        
        function calculateNutrition() {
            const numAnimals = parseInt(document.getElementById('calcNumAnimals').value);
            const avgWeight = parseFloat(document.getElementById('calcAvgWeight').value);
            const dailyConsumption = parseFloat(document.getElementById('calcDailyConsumption').value);
            const consumptionType = document.getElementById('calcConsumptionType').value;

            if (!numAnimals || !avgWeight || !dailyConsumption) {
                alert('Por favor, preencha todos os campos da calculadora.');
                return;
            }

            let dailyConsumptionPerAnimal = 0;

            if (consumptionType === 'percentage') {
                dailyConsumptionPerAnimal = (avgWeight * dailyConsumption) / 100;
            } else {
                dailyConsumptionPerAnimal = dailyConsumption / 1000;
            }

            const totalDailyConsumption = dailyConsumptionPerAnimal * numAnimals;
            const monthlyConsumption = totalDailyConsumption * 30;
            const bags30kg = Math.ceil(monthlyConsumption / 30);
            const bags40kg = Math.ceil(monthlyConsumption / 40);

            document.getElementById('resultDailyConsumption').innerText = `${totalDailyConsumption.toFixed(2)} kg`;
            document.getElementById('resultMonthlyConsumption').innerText = `${monthlyConsumption.toFixed(2)} kg`;
            document.getElementById('resultBags30kg').innerText = `${bags30kg} sacas`;
            document.getElementById('resultBags40kg').innerText = `${bags40kg} sacas`;
        ...
        async function addStockItem() {
            ...
            if(existingItem) {
                ...
                if(category === 'Sêmen') {
                    const photoUrl = (document.getElementById('stockSemenPhotoUrl').value || '').trim();
                    const pedigreeSire = (document.getElementById('stockSemenPedigreeSire').value || '').trim();
                    const pedigreeDam = (document.getElementById('stockSemenPedigreeDam').value || '').trim();
                    const pedigreeTree = (document.getElementById('stockSemenPedigreeTree').value || '').trim();
                    if(photoUrl) existingItem.photoUrl = photoUrl;
                    if(pedigreeSire) existingItem.pedigreeSire = pedigreeSire;
                    if(pedigreeDam) existingItem.pedigreeDam = pedigreeDam;
                    if(pedigreeTree) existingItem.pedigreeTree = pedigreeTree;
                }
            } else {
                appData.inventory.push({
                    ...
                    reg,
                    center,
                    photoUrl: category === 'Sêmen' ? (document.getElementById('stockSemenPhotoUrl').value || '').trim() : undefined,
                    pedigreeSire: category === 'Sêmen' ? (document.getElementById('stockSemenPedigreeSire').value || '').trim() : undefined,
                    pedigreeDam: category === 'Sêmen' ? (document.getElementById('stockSemenPedigreeDam').value || '').trim() : undefined,
                    pedigreeTree: category === 'Sêmen' ? (document.getElementById('stockSemenPedigreeTree').value || '').trim() : undefined
                });
            }
            if(autoLaunch) {
                appData.financials.push({
            ...
            document.getElementById('stockSemenCenter').value = '';
            document.getElementById('stockSemenPhotoUrl').value = '';
            document.getElementById('stockSemenPedigreeSire').value = '';
            document.getElementById('stockSemenPedigreeDam').value = '';
            document.getElementById('stockSemenPedigreeTree').value = '';
            renderAll();
        }

        function toggleEditSemenFields(category) {
            const el = document.getElementById('stockEditSemenFields');
            if (category === 'Sêmen') el.classList.remove('hidden');
        ...
        function openEditStockModal(itemId) {
            ...
            document.getElementById('stockEditCategory').value = item.category || 'Outros';
            document.getElementById('stockEditQty').value = item.currentQty != null ? item.currentQty : '';
            document.getElementById('stockEditUnit').value = item.unit || 'un';
            document.getElementById('stockEditAvgPrice').value = item.avgPrice != null ? item.avgPrice.toFixed(2) : '';
            const semenEdit = document.getElementById('stockEditSemenFields');
            if (item.category === 'Sêmen') {
                semenEdit.classList.remove('hidden');
                document.getElementById('stockEditPhotoUrl').value = item.photoUrl || '';
                document.getElementById('stockEditPedigreeSire').value = item.pedigreeSire || '';
                document.getElementById('stockEditPedigreeDam').value = item.pedigreeDam || '';
                document.getElementById('stockEditPedigreeTree').value = item.pedigreeTree || '';
            } else {
                semenEdit.classList.add('hidden');
            }
            openModal('modalEditStockItem');
        }

        async function saveStockItemEdit() {
            const id = document.getElementById('stockEditId').value;
            const name = document.getElementById('stockEditName').value.trim();
            const category = document.getElementById('stockEditCategory').value;
            const currentQty = parseFloat(document.getElementById('stockEditQty').value);
            const unit = document.getElementById('stockEditUnit').value;
            const avgPrice = parseFloat(document.getElementById('stockEditAvgPrice').value);

            if (!name) { alert('Informe o nome do produto.'); return; }
            if (currentQty < 0 || isNaN(currentQty)) { alert('Quantidade inválida.'); return; }
            if (avgPrice < 0 || isNaN(avgPrice)) { alert('Preço médio inválido.'); return; }
            ...
            if (category === 'Sêmen') {
                item.photoUrl = (document.getElementById('stockEditPhotoUrl').value || '').trim() || undefined;
                item.pedigreeSire = (document.getElementById('stockEditPedigreeSire').value || '').trim() || undefined;
                item.pedigreeDam = (document.getElementById('stockEditPedigreeDam').value || '').trim() || undefined;
                item.pedigreeTree = (document.getElementById('stockEditPedigreeTree').value || '').trim() || undefined;
            }
            await saveData();
            closeModal('modalEditStockItem');
            renderAll();
        }

        function openRemoveStockModal(itemId) {
            openRemoveStockModalWithId(itemId);
        }

        function openRemoveStockFromEdit() {
            const itemId = document.getElementById('stockEditId').value;
            if (!itemId) return;
            openRemoveStockModalWithId(itemId);
        }

        function openRemoveStockModalWithId(itemId) {
            const item = (appData.inventory || []).find(i => i.id == itemId);
            if (!item) return;
            document.getElementById('stockRemoveId').value = item.id;
            document.getElementById('stockRemoveItemName').innerText = item.name + ' (' + parseFloat(item.currentQty).toFixed(2) + ' ' + item.unit + ')';
            document.getElementById('stockRemoveAvailable').innerText = parseFloat(item.currentQty).toFixed(2) + ' ' + item.unit;
            document.getElementById('stockRemoveQty').value = '';
            document.getElementById('stockRemoveQty').max = item.currentQty;
            document.getElementById('stockRemoveQty').placeholder = 'Máx: ' + parseFloat(item.currentQty).toFixed(2);
            document.getElementById('stockRemoveAll').checked = false;
            document.getElementById('stockRemoveOtherText').value = '';
            document.getElementById('stockRemoveOtherWrap').classList.add('hidden');
            document.querySelectorAll('input[name="stockRemoveReason"]').forEach(r => { r.checked = false; });
            openModal('modalRemoveStock');
        }

        async function confirmRemoveStock() {
            const itemId = document.getElementById('stockRemoveId').value;
            const reasonEl = document.querySelector('input[name="stockRemoveReason"]:checked');
            const reason = reasonEl ? reasonEl.value : '';
            const removeAll = document.getElementById('stockRemoveAll').checked;
            let qty = parseFloat(document.getElementById('stockRemoveQty').value) || 0;

            if (!reason) { alert('Selecione o motivo da remoção.'); return; }

            const item = appData.inventory.find(i => i.id == itemId);
            if (!item) return;
            const available = parseFloat(item.currentQty) || 0;
            if (removeAll) qty = available;
            if (qty <= 0) { alert('Informe a quantidade a remover.'); return; }
            if (qty > available) { alert('Quantidade maior que o disponível.'); return; }

            item.currentQty = Math.max(0, available - qty);
            if (item.currentQty <= 0) {
                const idx = appData.inventory.findIndex(i => i.id == itemId);
                if (idx !== -1) appData.inventory.splice(idx, 1);
            }
            await saveData();
        ...
        function toggleStockRemoveOther() {
            const r = document.querySelector('input[name="stockRemoveReason"]:checked');
            const wrap = document.getElementById('stockRemoveOtherWrap');
            if (wrap) wrap.classList.toggle('hidden', !r || r.value !== 'Outros');
        }
        function toggleStockRemoveAll() {
            const cb = document.getElementById('stockRemoveAll');
            const qtyEl = document.getElementById('stockRemoveQty');
            if (!cb || !qtyEl) return;
            if (cb.checked) {
                const avail = document.getElementById('stockRemoveAvailable');
                const txt = (avail && avail.innerText) ? avail.innerText : '';
        ...
        function openGroupDetails(id) {
            ...
            const weightIndivAnimal = document.getElementById('weightIndivAnimal');
            weightIndivAnimal.innerHTML = '<option value="">Animal...</option>' + (group.animals || []).map(a => `<option value="${a.id}">${a.id}</option>`).join('');
            document.getElementById('weightIndivDate').value = new Date().toISOString().split('T')[0];
            ...
            renderSemenBankList();
            renderEliteMatricesList(group);
            const pSelect = document.getElementById('movePastureSelect');
            if(group.sold) {
                pSelect.disabled = true;
                pSelect.innerHTML = '<option>Lote vendido</option>';
            } else {
                pSelect.disabled = false;
                pSelect.innerHTML = '<option value="">Sem pasto definido</option>' + appData.pastures.map(p => `<option value="${p.id}" ${group.currentPastureId == p.id ? 'selected' : ''}>${p.name}</option>`).join('');
            }
        ...
        async function processGroupSale() {
            ...
            group.sold = true;
            group.salePrice = saleValue;
            group.saleDate = saleDate;
            group.currentPastureId = null;
            appData.financials.push({
                id: Date.now(),
                type: 'income',
                desc: `Venda Lote: ${group.name}`,
                amount: saleValue,
                date: saleDate,
                isGroupSale: true,
                groupId: group.id
        ...
        function populateStockUsageSelect() {
            ...
            select.innerHTML = '<option value="">Selecione...</option>' + filtered.map(i => `<option value="${i.id}" data-unit="${i.unit}">${i.name} (Disp: ${parseFloat(i.currentQty).toFixed(2)} ${i.unit})</option>`).join('');
        ...
        async function confirmStockUsage() {
            ...
            if(!prodId || !date) {
                alert('Selecione produto e data.');
                return;
            }
            if(scope === 'individual' && !animalId) {
        ...
        function populateBreedingStock() {
            ...
            select.innerHTML = '<option value="">Selecione Touro/Sêmen</option>' + bulls.map(b => `<option value="${b.id}" data-stock="${b.currentQty}">${b.name} (${b.currentQty} doses) - ${b.breed || ''}</option>`).join('');
            select.onchange = function() {
                const opt = select.options[select.selectedIndex];
                ...
                showBullPedigree(select.value);
            };
            showBullPedigree(select.value);
        }

        function showBullPedigree(bullId) {
            const box = document.getElementById('breedingBullPedigreeBox');
            const photoEl = document.getElementById('breedingBullPhoto');
            const pedigreeEl = document.getElementById('breedingBullPedigree');
            if(!bullId) {
                box.classList.add('hidden');
                return;
            }
            const item = (appData.inventory || []).find(i => i.id == bullId);
            if(!item || item.category !== 'Sêmen') {
                box.classList.add('hidden');
                return;
            }
            box.classList.remove('hidden');
            if(item.photoUrl) {
                photoEl.innerHTML = '<img src="' + item.photoUrl + '" alt="Touro" style="max-width:120px; max-height:120px; border-radius:10px; object-fit:cover;">';
            } else {
                photoEl.innerHTML = '<span class="text-gray text-sm">Sem foto</span>';
            }
            let pedigreeText = [];
            if(item.pedigreeSire) pedigreeText.push('Pai: ' + item.pedigreeSire);
            if(item.pedigreeDam) pedigreeText.push('Mãe: ' + item.pedigreeDam);
            if(item.pedigreeTree) pedigreeText.push(item.pedigreeTree);
            pedigreeEl.innerHTML = pedigreeText.length ? pedigreeText.join(' | ') : '<span class="text-gray">Pedigree não informado</span>';
        }

        function renderSemenBankList() {
            const list = document.getElementById('semenBankList');
            const semenItems = (appData.inventory || []).filter(i => i.category === 'Sêmen');
            if(semenItems.length === 0) {
                list.innerHTML = '<p class="text-sm text-gray text-center">Nenhum touro cadastrado no estoque.</p>';
                return;
            }
            list.innerHTML = semenItems.map(b => {
                let photoHtml = b.photoUrl ? '<img src="' + b.photoUrl + '" alt="" style="width:48px; height:48px; border-radius:8px; object-fit:cover;">' : '<span class="text-gray text-xs">Sem foto</span>';
                let pedigreeParts = [];
                if(b.pedigreeSire) pedigreeParts.push('Pai: ' + b.pedigreeSire);
                if(b.pedigreeDam) pedigreeParts.push('Mãe: ' + b.pedigreeDam);
                if(b.pedigreeTree) pedigreeParts.push(b.pedigreeTree);
                const pedigreeStr = pedigreeParts.length ? pedigreeParts.join(' · ') : '—';
                return `<div class="list-item text-sm" style="display:flex; align-items:center; gap:12px;">
                    <div style="flex-shrink:0;">${photoHtml}</div>
                    <div style="flex:1; min-width:0;">
                        <strong>${b.name}</strong> ${b.breed ? '(' + b.breed + ')' : ''}
                        <div class="text-xs text-gray" style="margin-top:4px;">${pedigreeStr}</div>
                    </div>
                    <span class="badge">${b.currentQty} doses</span>
                </div>`;
            }).join('');
        }

        function getAnimalGMD(animal) {
            if(!animal.weighings || animal.weighings.length < 2) return null;
            const sorted = [...animal.weighings].sort((a,b) => new Date(a.date) - new Date(b.date));
            const first = sorted[0], last = sorted[sorted.length - 1];
            const diffDays = Math.ceil((new Date(last.date) - new Date(first.date)) / (1000*60*60*24));
            if(diffDays <= 0) return null;
            return ((last.weight - first.weight) / diffDays).toFixed(3);
        }

        function getEliteMatricesRanking(group) {
            const allCalves = [];
            (appData.groups || []).forEach(g => {
                (g.animals || []).forEach(a => {
                    if(a.motherId) allCalves.push({ ...a, groupId: g.id });
                });
            });
            const byMother = {};
            allCalves.forEach(c => {
                if(!byMother[c.motherId]) byMother[c.motherId] = [];
                byMother[c.motherId].push(c);
            });
            const groupAnimalIds = new Set((group.animals || []).map(a => a.id));
            const ranking = [];
            Object.keys(byMother).forEach(motherId => {
                if(!groupAnimalIds.has(motherId)) return;
                const calves = byMother[motherId];
                let sumGMD = 0, count = 0;
                calves.forEach(c => {
                    const gmd = getAnimalGMD(c);
                    if(gmd != null) { sumGMD += parseFloat(gmd); count++; }
                });
                if(count === 0) return;
                ranking.push({ motherId, avgGMD: (sumGMD / count).toFixed(3), calfCount: calves.length });
            });
            ranking.sort((a,b) => parseFloat(b.avgGMD) - parseFloat(a.avgGMD));
            return ranking;
        }

        function renderEliteMatricesList(group) {
            const list = document.getElementById('eliteMatricesList');
            const ranking = getEliteMatricesRanking(group);
            if(ranking.length === 0) {
                list.innerHTML = '<p class="text-sm text-gray text-center">Registre bezerros com "Matriz (mãe)" e pesagens individuais para ver o ranking.</p>';
                return;
            }
            list.innerHTML = ranking.map((r, i) => `
                <div class="list-item text-sm">
                    <span class="badge" style="background:var(--pink); color:white;">#${i+1}</span>
                    <strong>${r.motherId}</strong> — GMD médio dos bezerros: <strong>${r.avgGMD} kg/dia</strong> (${r.calfCount} bezerro(s))
                </div>
            `).join('');
        }
        ...
        async function saveInsemination() {
            ...
            if(!date || !bullId) {
                alert("Data e Touro são obrigatórios.");
                return;
            }
            if(scope === 'individual' && !animalId) {
            ...
            group.costHistory.push({
                ...
                scope,
                animalId: scope === 'individual' ? animalId : null,
                brand: bullItem.brand,
                batch: bullItem.batch
            });
            ...
            const eventData = {
                ...
                date,
                type,
                bullName: bullItem.name,
                inseminator,
                ecc,
                scope,
                animalId: scope === 'individual' ? animalId : 'LOTE',
            ...
            list.innerHTML = [...group.breedingEvents].sort((a,b) => new Date(b.date) - new Date(a.date)).map(evt => {
                ...
                return `
                    <div class="list-item" style="display:block;">
                        <div class="flex-between">
                            <div>
                                <strong>${new Date(evt.date).toLocaleDateString('pt-BR')}</strong>
                                <span class="badge badge-pink">${evt.type}</span>
        ...
        async function addIndividualWeight() {
            const date = document.getElementById('weightIndivDate').value;
            const animalId = document.getElementById('weightIndivAnimal').value;
            const weight = parseFloat(document.getElementById('weightIndivValue').value);
            if(!date || !animalId || !weight) {
                alert('Preencha data, animal e peso.');
                return;
            }
            const group = appData.groups.find(g => g.id == activeGroupId);
            if(group.sold) return;
            const animal = (group.animals || []).find(a => a.id === animalId);
            if(!animal) return;
            if(!animal.weighings) animal.weighings = [];
            const existing = animal.weighings.find(w => w.date === date);
            if(existing) existing.weight = weight;
            else animal.weighings.push({ date, weight });
            animal.weight = weight;
            await saveData();
            renderWeightList(group);
            renderAnimalList(group);
            renderEliteMatricesList(group);
            document.getElementById('weightIndivValue').value = '';
        }

        function renderWeightList(group) {
            const list = document.getElementById('weightHistoryList');
            const weighings = group.weighings || [];
            list.innerHTML = weighings.sort((a,b) => new Date(b.date) - new Date(a.date)).map(w =>
        ...
        async function addAnimalToGroup() {
            ...
            renderAnimalList(group);
            renderAll();
            const group2 = appData.groups.find(g => g.id == activeGroupId);
            if(group2) renderEliteMatricesList(group2);
        }
        ...
        function renderAnimalList(group) {
            ...
            list.innerHTML = group.animals.map((a, idx) =>
                `<div class="list-item text-sm">
                    <div onclick="openAnimalDetails(${idx})" style="cursor:pointer; flex:1;">
                        <span><i class="fas fa-tag"></i> <strong>${a.id}</strong></span>
                        <div class="text-xs text-gray">Peso: ${a.weight ? a.weight.toFixed(2) + ' kg' : 'N/A'}</div>
                    </div>
                    <div class="btn-group-row">
                        <button class="btn btn-outline btn-sm" onclick="openEditAnimal(${idx})"><i class="fas fa-pencil-alt"></i></button>
                        <button class="btn btn-danger btn-sm" onclick="openRemoveAnimalModal(${idx})"><i class="fas fa-trash"></i></button>
                    </div>
                </div>`
            ).join('');
        }
        ...
        async function saveAnimalEdit() {
            ...
            if(newWeight > 0) {
                if(!animal.weighings) animal.weighings = [];
                const today = new Date().toISOString().split('T')[0];
                const existing = animal.weighings.find(w => w.date === today);
                if(existing) existing.weight = newWeight;
                else animal.weighings.push({ date: today, weight: newWeight });
            }
        ...
        function openRemoveAnimalModal(idx) {
            ...
            const animal = group.animals[idx];
            document.getElementById('removeAnimalIndex').value = idx;
            document.getElementById('removeAnimalName').innerText = animal.id;
            document.getElementById('removeReason').value = '';
            document.getElementById('deathCause').value = '';
            document.getElementById('removeDate').value = new Date().toISOString().split('T')[0];
            document.getElementById('removeNotes').value = '';
            document.getElementById('deathCauseBlock').classList.add('hidden');

            openModal('modalRemoveAnimal');
        }

        function toggleDeathCause() {
            const reason = document.getElementById('removeReason').value;
            const deathBlock = document.getElementById('deathCauseBlock');

            if(reason === 'Morte') {
                deathBlock.classList.remove('hidden');
            } else {
                deathBlock.classList.add('hidden');
            }
        }

        async function confirmRemoveAnimal() {
            const idx = document.getElementById('removeAnimalIndex').value;
            const reason = document.getElementById('removeReason').value;
            ...
            if(!reason || !date) {
                alert('Preencha o motivo e a data.');
                return;
            }

            if(reason === 'Morte' && !deathCause) {
                alert('Selecione a causa da morte.');
                return;
            }
            ...
            if(!appData.animalLosses) appData.animalLosses = [];

            appData.animalLosses.push({
                id: Date.now(),
                animalId: animal.id,
                groupName: group.name,
                groupId: group.id,
                reason: reason,
                deathCause: reason === 'Morte' ? deathCause : null,
                date: date,
                notes: notes,
            ...
            await saveData();
            closeModal('modalRemoveAnimal');
            renderAnimalList(group);
            renderAll();
            alert(`Animal ${animal.id} removido do lote. Motivo: ${reason}`);
        }

        let animalGrowthChartInstance = null;

        function openAnimalDetails(idx) {
            const group = appData.groups.find(g => g.id == activeGroupId);
            const animal = group.animals[idx];

            document.getElementById('animalDetailId').innerText = animal.id;
            document.getElementById('animalDetailWeight').innerText = animal.weight ? animal.weight.toFixed(2) + ' kg' : 'Não informado';
            document.getElementById('animalDetailEntry').innerText = new Date(animal.entryDate).toLocaleDateString('pt-BR');

            renderAnimalGrowthChart(group, animal);
            openModal('modalAnimalDetails');
        }

        function renderAnimalGrowthChart(group, animal) {
            const ctx = document.getElementById('animalGrowthChart').getContext('2d');

            if(animalGrowthChartInstance) {
                animalGrowthChartInstance.destroy();
            }

            const weighings = group.weighings || [];
            const labels = weighings.map(w => new Date(w.date).toLocaleDateString('pt-BR', {month: 'short', day: 'numeric'}));
            const animalWeights = [];
            const avgWeights = [];

            if(weighings.length > 0) {
                const currentWeight = animal.weight || weighings[weighings.length - 1].weight;
                const gmd = parseFloat(calculateGMD(group)) || 0.5;

                for(let i = 0; i < weighings.length; i++) {
                    const daysBack = weighings.length - i - 1;
                    animalWeights.push(currentWeight - (gmd * daysBack * 30));
                    avgWeights.push(weighings[i].weight);
                }
            } else {
                labels.push('Atual');
                animalWeights.push(animal.weight || 0);
                avgWeights.push(getCurrentLotWeight(group).weight);
            }

            animalGrowthChartInstance = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: labels,
                    datasets: [
                        {
                            label: `${animal.id} (Individual)`,
                            data: animalWeights,
                            borderColor: '#2563eb',
        ...
        function openTransactionModal(type) {
            ...
            document.getElementById('btnTransExcluir').style.display = 'none';
        ...
        function openEditTransactionModal(idOrIndex) {
            const list = appData.financials || [];
            let t = list.find(x => x.id == idOrIndex);
            if (!t && typeof idOrIndex === 'number' && idOrIndex >= 0 && idOrIndex < list.length) t = list[idOrIndex];

            if (!t) return;
            if (t.id == null) t.id = 'legacy_' + Date.now();

            document.getElementById('transId').value = t.id;
            document.getElementById('btnTransExcluir').style.display = '';
            document.getElementById('transType').value = t.type;
            document.getElementById('transDesc').value = t.desc || '';
            document.getElementById('transAmount').value = t.amount != null ? t.amount : '';
            document.getElementById('transDate').value = (t.date || '').toString().substring(0, 10);
            document.getElementById('transNotes').value = t.notes || '';

            document.getElementById('transTitle').innerText = t.type === 'income' ? 'Editar Receita' : 'Editar Despesa';
            document.getElementById('transTitle').className = t.type === 'income' ? 'text-success' : 'text-danger';
            document.getElementById('btnSaveTrans').className = t.type === 'income' ? 'btn btn-success' : 'btn btn-danger';
        ...
        async function saveTransaction() {
            ...
            if (transId !== '') {
                const idx = appData.financials.findIndex(x => x.id == transId);
                if (idx === -1) return;
                const existing = appData.financials[idx];
                existing.type = type;
                existing.desc = desc;
        ...
        async function removeTransaction() {
            const transId = document.getElementById('transId').value;
            if (!transId) return;
            if (!confirm('Remover esta receita/despesa? Esta ação não pode ser desfeita.')) return;
            const idx = appData.financials.findIndex(x => x.id == transId);
            if (idx === -1) return;
            appData.financials.splice(idx, 1);
            await saveData();
            closeModal('modalTransaction');
            renderAll();
        }
        ...
        async function loadAdminUserList() {
            ...
            try {
                ...
                listContainer.innerHTML = '<p class="text-danger">Erro ao listar usuários.</p>';
            }
        }
        ...
        function renderAdminList() {
            ...
            if(allUsersCache.length === 0) {
                listContainer.innerHTML = '<p>Nenhum usuário.</p>';
                return;
            }
            ...
            listContainer.innerHTML = allUsersCache.map(u => {
                ...
                // Informações de contas para gerentes
                let managerAccountsInfo = '';
                if (u.role === 'manager') {
                    const maxAccounts = u.maxAccounts || 0;
                    const createdAccounts = u.createdAccounts || [];
                    const createdCount = Array.isArray(createdAccounts) ? createdAccounts.length : 0;
                    
                    managerAccountsInfo = `
                        <div style="margin-top: 10px; padding: 10px; background: var(--bg-light); border-radius: 6px; border: 1px solid var(--border);">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                                <div>
                                    <span class="text-xs text-gray"><i class="fas fa-users"></i> Contas Criadas:</span>
                                    <strong style="color: var(--primary); margin-left: 5px;">${createdCount} / ${maxAccounts || '∞'}</strong>
                                </div>
                            </div>
                            <div style="display: flex; gap: 8px; align-items: center;">
                                <label class="text-xs text-gray" style="white-space: nowrap;">Limite Máximo:</label>
                                <input type="number" 
                                       id="maxAccounts_${u.id}" 
                                       value="${maxAccounts}" 
                                       min="0" 
                                ...
                                <button class="btn btn-sm btn-primary" 
                                        onclick="updateManagerMaxAccounts('${u.id}')" 
        ...
        async function changeUserRole(targetId, newRole) {
            if(!confirm(`Alterar para ${newRole.toUpperCase()}?`)) {
                loadAdminUserList();
                return;
            }
        ...
        async function updateManagerMaxAccounts(managerId) {
            const inputElement = document.getElementById(`maxAccounts_${managerId}`);
            if (!inputElement) return;

            const maxAccounts = parseInt(inputElement.value) || 0;
            
            if (maxAccounts < 0) {
                alert('O número máximo de contas não pode ser negativo.');
                inputElement.focus();
                return;
            }

            try {
                // Verificar se o gerente já criou mais contas do que o novo limite
                const managerData = allUsersCache.find(u => u.id === managerId);
                if (managerData) {
                    const createdAccounts = managerData.createdAccounts || [];
                    const createdCount = Array.isArray(createdAccounts) ? createdAccounts.length : 0;
                    
                    if (maxAccounts > 0 && createdCount > maxAccounts) {
                        if (!confirm(`Atenção: Este gerente já criou ${createdCount} contas. O novo limite será ${maxAccounts}. Isso não removerá as contas existentes, mas impedirá a criação de novas até que algumas sejam removidas. Deseja continuar?`)) {
                            // Restaurar valor anterior
                            inputElement.value = managerData.maxAccounts || 0;
                            return;
                        }
                    }
                }

                await db.collection('auth').doc(managerId).update({ 
                    maxAccounts: maxAccounts 
                });

                // Atualizar cache
                if (managerData) {
                    managerData.maxAccounts = maxAccounts;
                }
                ...
                alert('Erro ao atualizar limite: ' + (e.message || 'tente novamente.'));
                console.error('Erro:', e);
            }
        }

        // ===== LÓGICA DE RELATÓRIOS PDF COM FILTROS =====
        ...
        async function generatePDF() {
            ...
            if (reportDateFilter.type === 'custom') {
                if (!reportDateFilter.startDate || !reportDateFilter.endDate) {
                    alert('Por favor, selecione as datas inicial e final.');
                    return;
                }

                if (new Date(reportDateFilter.startDate) > new Date(reportDateFilter.endDate)) {
            ...
            const startFormatted = new Date(reportDateFilter.startDate).toLocaleDateString('pt-BR');
            const endFormatted = new Date(reportDateFilter.endDate).toLocaleDateString('pt-BR');
            dateRangeEl.innerText = `${startFormatted} a ${endFormatted}`;
            ...
            if (type === 'financial') {
                ...
                const filteredFinancials = appData.financials.filter(f => isDateInRange(f.date));

                const rows = filteredFinancials.sort((a,b) => new Date(b.date) - new Date(a.date)).map(f => {
                ...
                contentHtml = `
                    ...
                    <table class="pdf-table">
                        ...
                        <tbody>${rows || '<tr><td colspan="4">Nenhuma transação no período</td></tr>'}</tbody>
                    </table>`;
                ...
                if (group) {
                    ...
                    const filteredCosts = (group.costHistory || []).filter(c => isDateInRange(c.date));

                    const costRows = filteredCosts.map(c =>
                        `<tr>
                    ...
                    const animalRows = (group.animals || []).map(a =>
                        `<tr>
                            <td>${a.id}</td>
                    ...
                    const totalCostInPeriod = filteredCosts.reduce((sum, c) => sum + c.totalCost, 0);
                    ...
                    contentHtml = `
                        <div style="background:#f3f4f6; padding:10px; border-radius:8px; margin-bottom:15px;">
                            ...
                            <strong>Custo no Período:</strong> R$ ${totalCostInPeriod.toFixed(2)}
                        </div>
                        <h3>Custos e Insumos (Período Selecionado)</h3>
                        <table class="pdf-table" style="margin-bottom:20px;">
                            ...
                            <tbody>${costRows || '<tr><td colspan="4">Sem registros no período</td></tr>'}</tbody>
                        </table>
                ...
                const filteredRainfall = appData.rainfall.filter(r => isDateInRange(r.date));

                const rows = filteredRainfall.map(r => {
                    totalMm += r.mm;
                    return `<tr>
                ...
                contentHtml = `
                    <div style="margin-bottom:15px;"><strong>Acumulado no Período:</strong> ${totalMm} mm</div>
                    <table class="pdf-table">
                        <thead><tr><th>Data</th><th class="text-right">Milímetros (mm)</th></tr></thead>
                        <tbody>${rows || '<tr><td colspan="2">Nenhum registro no período</td></tr>'}</tbody>
                    </table>`;
                ...
                appData.groups.forEach(g => {
                    if(g.health && g.health.length > 0) {
                        const filteredHealth = g.health.filter(h => isDateInRange(h.date));

                        if(filteredHealth.length > 0) {
                            const healthRows = filteredHealth.map(h =>
                                `<tr>
                ...
                contentHtml = htmlBuilder || '<p>Nenhum registro sanitário encontrado no período selecionado.</p>';
            } else if (type === 'loss_analysis') {
                titleEl.innerText = 'Análise de Perdas e Mortes';

                const filteredLosses = (appData.animalLosses || []).filter(loss => isDateInRange(loss.date));

                if(filteredLosses.length === 0) {
                    contentHtml = '<p>Nenhuma perda registrada no período selecionado.</p>';
                } else {
                    const lossStats = {};
                    filteredLosses.forEach(loss => {
                        const key = loss.reason === 'Morte' ? `Morte - ${loss.deathCause}` : loss.reason;
                        if(!lossStats[key]) lossStats[key] = 0;
                        lossStats[key]++;
                    });

                    const statsRows = Object.entries(lossStats).map(([reason, count]) =>
                        `<tr>
                            <td>${reason}</td>
                    ...
                    const detailRows = filteredLosses.sort((a,b) => new Date(b.date) - new Date(a.date)).map(loss =>
                        `<tr>
                            <td>${new Date(loss.date).toLocaleDateString('pt-BR')}</td>
                            <td>${loss.animalId}</td>
                            <td>${loss.groupName}</td>
                            <td>${loss.reason}</td>
                            <td>${loss.deathCause || '-'}</td>
                            <td>${loss.notes || '-'}</td>
                        </tr>`
                    ).join('');

                    contentHtml = `
                        <h3>Resumo por Motivo (Período Selecionado)</h3>
                        <table class="pdf-table" style="margin-bottom:30px;">
                            <thead><tr><th>Motivo</th><th class="text-right">Quantidade</th></tr></thead>
                            <tbody>${statsRows}</tbody>
                        </table>
                        <h3>Detalhamento Completo</h3>
                        <table class="pdf-table">
                            <thead><tr><th>Data</th><th>Animal</th><th>Lote</th><th>Motivo</th><th>Causa</th><th>Obs</th></tr></thead>
            ...
            const opt = {
                margin: 0,
                filename: `Relatorio_MeuGado_${type}_${reportDateFilter.startDate}_${reportDateFilter.endDate}.pdf`,
                image: { type: 'jpeg', quality: 0.98 },
                html2canvas: { scale: 2, useCORS: true },
                jsPDF: { unit: 'mm', format: 'a4', orientation: 'portrait' }
            };
        ...
        function renderAll() {
            let totalAnimals = 0;
            appData.groups.forEach(g => {
                if(!g.sold) totalAnimals += (g.animals.length || g.quantity);
            });
            ...
            document.getElementById('pasturesGrid').innerHTML = appData.pastures.map(p => {
                ...
                return `<div class="paddock-cell ${isOccupied ? 'occupied' : ''}" onclick="openEditPasture(${p.id})">
                    ...
                    <div style="font-size:0.7rem; margin-top:4px;">${ua} UA/ha</div>
            ...
            if(appData.inventory.length === 0) inventoryList.innerHTML = '<p class="text-center text-gray" style="padding:20px;">Vazio.</p>';
                ...
                let badgeClass = i.category === 'Vacina' ? 'badge-danger' : (i.category === 'Ração' ? 'badge-success' : (i.category === 'Sêmen' ? 'badge-pink' : 'badge-info'));
                const editArg = typeof i.id === 'number' ? i.id : "'" + String(i.id).replace(/'/g, "\\'") + "'";

                return `<div class="list-item" style="align-items: center;">
                    <div style="flex:1;"><div style="font-weight:bold;">${i.name} <span class="badge ${badgeClass}">${i.category}</span></div><div class="text-sm text-gray">Médio: R$ ${i.avgPrice.toFixed(2)}</div></div>
                    <div style="display:flex; align-items:center; gap:8px;">
                        <div class="text-center" style="font-weight:bold; font-size:1.1rem; color:var(--primary);">${parseFloat(i.currentQty).toFixed(2)} ${i.unit}</div>
                        <button type="button" class="btn btn-sm btn-outline" onclick="openEditStockModal(${editArg})" title="Editar"><i class="fas fa-edit"></i></button>
                    </div>
                </div>`;
            }).join('');
            ...
            listFin.innerHTML = allTrans.map(t => {
                const editId = t.id != null ? t.id : appData.financials.indexOf(t);
                const editArg = typeof editId === 'number' ? editId : "'" + String(editId).replace(/'/g, "\\'") + "'";
                const notesHtml = (t.notes && t.notes.trim()) ? `<div class="text-sm text-gray" style="margin-top:4px;"><i class="fas fa-sticky-note"></i> ${t.notes.trim()}</div>` : '';
                return `<div class="list-item" style="align-items: flex-start;">
                    <div style="flex:1;"><div style="font-weight:600;">${t.desc}</div><div class="text-sm text-gray">${new Date(t.date).toLocaleDateString('pt-BR')}</div>${notesHtml}</div>
                    <div style="display:flex; align-items:center; gap:8px;">
                        <div class="${t.type === 'income' ? 'text-success' : 'text-danger'}" style="font-weight:bold;">${t.type === 'income' ? '+' : '-'} R$ ${t.amount.toFixed(2)}</div>
                        <button type="button" class="btn btn-sm btn-outline" onclick="openEditTransactionModal(${editArg})" title="Editar"><i class="fas fa-edit"></i></button>
                    </div>
                </div>`;
            }).join('');
            ...
            chartInstance = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Chuva (mm)',
                            data: appData.rainfall.map(r=>r.mm),
                            backgroundColor: '#60a5fa',
                            yAxisID: 'y'
                        },
                        {
                            label: 'Peso Simulado',
                            data: appData.rainfall.map(r=>Math.random()*5+300),
                            type: 'line',
                            borderColor: '#059669',
                            yAxisID: 'y1'
                        }
            ...
            renderLossAnalysisChart();
            renderTasks();
            renderNotifications();
        }

        function renderLossAnalysisChart() {
            const ctx = document.getElementById('lossAnalysisChart').getContext('2d');

            if(lossChartInstance) {
                lossChartInstance.destroy();
            }

            if(!appData.animalLosses || appData.animalLosses.length === 0) {
                ctx.font = '14px Inter';
                ctx.fillStyle = '#6b7280';
                ctx.textAlign = 'center';
                ctx.fillText('Nenhuma perda registrada', ctx.canvas.width / 2, ctx.canvas.height / 2);
                return;
            }

            const lossStats = {};
            appData.animalLosses.forEach(loss => {
                const key = loss.reason === 'Morte' ? `Morte - ${loss.deathCause}` : loss.reason;
                if(!lossStats[key]) lossStats[key] = 0;
                lossStats[key]++;
            });

            const labels = Object.keys(lossStats);
            const data = Object.values(lossStats);
            ...
            lossChartInstance = new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Por que estou perdendo dinheiro?',
                            font: {
                                size: 16,
                                weight: 'bold'
                            }
        ...
        async function openSettingsModal() {
            if (currentUser) {
                ...
                document.getElementById('settingsContactMessage').textContent = '';
                
                // Carregar informações de contas para gerentes
                if (currentUser.role === 'manager') {
                    try {
                        const userDoc = await db.collection('auth').doc(currentUser.id).get();
                        if (userDoc.exists) {
                            const userData = userDoc.data();
                            const maxAccounts = userData.maxAccounts || 0;
                            const createdAccounts = userData.createdAccounts || [];
                            const createdCount = Array.isArray(createdAccounts) ? createdAccounts.length : 0;
                            
                            document.getElementById('managerMaxAccounts').textContent = maxAccounts;
                            document.getElementById('managerCreatedAccounts').textContent = createdCount;
                            document.getElementById('managerAccountsMessage').textContent = '';
                            
                            // Mostrar/ocultar seção e habilitar/desabilitar botão
                            const accountsSection = document.getElementById('managerAccountsSection');
                            accountsSection.style.display = 'block';
                            
                            const btnCreate = document.getElementById('btnCreateAccount');
                            if (createdCount >= maxAccounts && maxAccounts > 0) {
                                btnCreate.disabled = true;
                                btnCreate.innerHTML = '<i class="fas fa-ban"></i> Limite de contas atingido';
                                btnCreate.style.opacity = '0.6';
                            } else {
                                btnCreate.disabled = false;
                                btnCreate.innerHTML = '<i class="fas fa-user-plus"></i> Criar Nova Conta Básica';
                                btnCreate.style.opacity = '1';
                            }
                        }
                    } catch (err) {
                        console.error('Erro ao carregar informações de contas:', err);
                    }
                } else {
                    document.getElementById('managerAccountsSection').style.display = 'none';
                }
            }
        ...
        async function saveContactSettings() {
            ...
            const msgEl = document.getElementById('settingsContactMessage');
            if (email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
            ...
            if (!currentUser || !currentUser.id) return;
            try {
                await db.collection('auth').doc(currentUser.id).update({ email: email || '', phone: phone || '' });
                currentUser.email = email || '';
                currentUser.phone = phone || '';
                localStorage.setItem('meugado_user', JSON.stringify(currentUser));
                msgEl.textContent = 'Dados de contato salvos.';
                msgEl.style.color = 'var(--success)';
            } catch (err) {
                msgEl.textContent = 'Erro ao salvar: ' + (err.message || 'tente novamente.');
                msgEl.style.color = 'var(--danger)';
            }
        }
        ...
        function openCreateAccountModal() {
            if (!currentUser || currentUser.role !== 'manager') {
                alert('Apenas gerentes podem criar contas.');
                return;
            }
        ...
        async function createBasicAccount() {
            ...
            // Validações
            if (user.length < 3) {
                msgEl.textContent = 'Nome de usuário muito curto (mínimo 3 caracteres).';
                msgEl.style.color = 'var(--danger)';
                return;
            }

            if (!name || name.length < 2) {
                msgEl.textContent = 'Nome completo é obrigatório (mínimo 2 caracteres).';
                msgEl.style.color = 'var(--danger)';
                return;
            }
            ...
            try {
                const managerDoc = await db.collection('auth').doc(currentUser.id).get();
                if (!managerDoc.exists) {
                    msgEl.textContent = 'Erro: Gerente não encontrado.';
                    msgEl.style.color = 'var(--danger)';
                    return;
                }

                const managerData = managerDoc.data();
                const maxAccounts = managerData.maxAccounts || 0;
                const createdAccounts = managerData.createdAccounts || [];
                const createdCount = Array.isArray(createdAccounts) ? createdAccounts.length : 0;

                if (maxAccounts > 0 && createdCount >= maxAccounts) {
                    msgEl.textContent = `Limite de contas atingido (${createdCount}/${maxAccounts}).`;
                    msgEl.style.color = 'var(--danger)';
                    return;
                }
                ...
                const authDoc = await db.collection('auth').doc(userId).get();
                if (authDoc.exists) {
                    msgEl.textContent = 'Este nome de usuário já existe. Escolha outro.';
                    msgEl.style.color = 'var(--danger)';
                    return;
                }

                // Criar a conta básica
                await db.collection('auth').doc(userId).set({
                    userName: user,
                    fullName: name,
                    email: email || '',
                    ...
                    role: 'basic',
                    managedFarms: [],
                    status_assinatura: 'ativo', // Contas criadas por gerentes já entram ativas
                    createdByManager: currentUser.id // Rastrear quem criou
                });

                // Adicionar à lista de contas criadas do gerente
                const updatedCreatedAccounts = [...createdAccounts, userId];
                await db.collection('auth').doc(currentUser.id).update({
                    createdAccounts: updatedCreatedAccounts
                });

                // Adicionar automaticamente ao managedFarms do gerente
                const currentManagedFarms = currentUser.managedFarms || [];
                if (!currentManagedFarms.includes(userId)) {
                    const updatedManagedFarms = [...currentManagedFarms, userId];
                    await db.collection('auth').doc(currentUser.id).update({
                        managedFarms: updatedManagedFarms
                    });
                    currentUser.managedFarms = updatedManagedFarms;
                    localStorage.setItem('meugado_user', JSON.stringify(currentUser));
                    
                    // Atualizar o seletor de fazendas se necessário
                    await setupRoleBasedUI();
                }

                msgEl.textContent = `Conta "${name}" criada com sucesso! Ela já está disponível nas fazendas gerenciadas.`;
                msgEl.style.color = 'var(--success)';

                // Atualizar contador na tela de configurações
                document.getElementById('managerCreatedAccounts').textContent = updatedCreatedAccounts.length;

                // Verificar se atingiu o limite
                if (maxAccounts > 0 && updatedCreatedAccounts.length >= maxAccounts) {
                    const btnCreate = document.getElementById('btnCreateAccount');
                    btnCreate.disabled = true;
                    btnCreate.innerHTML = '<i class="fas fa-ban"></i> Limite de contas atingido';
                    btnCreate.style.opacity = '0.6';
                ...
                msgEl.textContent = 'Erro ao criar conta: ' + (err.message || 'tente novamente.');
                msgEl.style.color = 'var(--danger)';
            }
        }
    ...
    <script>
        // Função para calcular o preço do Plano para Gerentes no app.html
        function calcularPrecoGerenteApp() {
            const numFazendasInput = document.getElementById('numFazendasApp');
            const priceElement = document.getElementById('gerentePriceApp');
            
            if (!numFazendasInput || !priceElement) return;
            
            const numFazendas = parseInt(numFazendasInput.value) || 1;
            const valorBase = 85.90;
            const valorPorFazenda = 20.90;
            
            // Garantir que seja pelo menos 1 fazenda
            const fazendas = Math.max(1, numFazendas);
            
            // Calcular: base + (fazendas - 1) * valor por fazenda
            const total = valorBase + (fazendas - 1) * valorPorFazenda;
            
            // Formatar o valor em reais
            const valorFormatado = total.toFixed(2).replace('.', ',');
            
            // Atualizar o preço exibido
            priceElement.innerHTML = `R$ ${valorFormatado}<span style="font-size: 1rem; color: var(--gray);">/mês</span>`;
        }

        // Inicializar o cálculo quando a tela de planos for exibida
        document.addEventListener('DOMContentLoaded', function() {
            // Verificar se o elemento existe e inicializar
            const numFazendasInput = document.getElementById('numFazendasApp');
            if (numFazendasInput) {
                calcularPrecoGerenteApp();
            }
        });
    </script>
